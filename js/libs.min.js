...
! function (e, t) {
    ...
    function v(e, t, n) {
        ...
        if (a.text = e, t)
            for (r in y)(i = t[r] || t.getAttribute && t.getAttribute(r)) && a.setAttribute(r, i);
    ...
    T.fn = T.prototype = {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[o] || {}, o++), "object" == typeof s || m(s) || (s = {}), o === l && (s = this, o--); o < l; o++)
            if (null != (e = arguments[o]))
                for (t in e) r = e[t], "__proto__" !== t && s !== r && (c && r && (T.isPlainObject(r) || (i = Array.isArray(r))) ? (n = s[t], a = i && !Array.isArray(n) ? [] : i || T.isPlainObject(n) ? n : {}, i = !1, s[t] = T.extend(c, a, r)) : void 0 !== r && (s[t] = r));
        return s
    }, T.extend({
        ...
        makeArray: function (e, t) {
            var n = t || [];
            return null != e && (x(Object(e)) ? T.merge(n, "string" == typeof e ? [e] : e) : s.call(n, e)), n
        },
    ...
    var P =
         ...
         */
        function (e) {
            var t, n, r, i, a, s, o, l, c, u, d, p, f, m, h, g, y, v, b, w = "sizzle" + 1 * new Date,
                T = e.document,
                x = 0,
                P = 0,
                C = le(),
            ...
            try {
                $.apply(j = I.call(T.childNodes), T.childNodes), j[T.childNodes.length].nodeType
            } catch (e) {
                $ = {
            ...
            function oe(e, t, r, i) {
                var a, o, c, u, d, m, y, v = t && t.ownerDocument,
                    T = t ? t.nodeType : 9;
                ...
                if (!i && (p(t), t = t || f, h)) {
                    if (11 !== T && (d = J.exec(e)))
                        if (a = d[1]) {
                            ...
                            } else if (v && (c = v.getElementById(a)) && b(t, c) && c.id === a) return r.push(c), r
                        } else {
                            if (d[2]) return $.apply(r, t.getElementsByTagName(e)), r;
                            if ((a = d[3]) && n.getElementsByClassName && t.getElementsByClassName) return $.apply(r, t.getElementsByClassName(a)), r
                        } if (n.qsa && !k[e + " "] && (!g || !g.test(e)) && (1 !== T || "object" !== t.nodeName.toLowerCase())) {
                        if (y = e, v = t, 1 === T && (H.test(e) || q.test(e))) {
                            for ((v = ee.test(e) && ye(t.parentNode) || t) === t && n.scope || ((u = t.getAttribute("id")) ? u = u.replace(re, ie) : t.setAttribute("id", u = w)), o = (m = s(e)).length; o--;) m[o] = (u ? "#" + u : ":scope") + " " + be(m[o]);
                            y = m.join(",")
                        }
                        try {
            ...
            for (t in n = oe.support = {}, a = oe.isXML = function (e) {
                    ...
                    return s != f && 9 === s.nodeType && s.documentElement ? (m = (f = s).documentElement, h = !a(f), T != f && (i = f.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", ae, !1) : i.attachEvent && i.attachEvent("onunload", ae)), n.scope = ue((function (e) {
                        ...
                        var t;
                        m.appendChild(e).innerHTML = "<a id='" + w + "'></a><select id='" + w + "-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll("[msallowcapture^='']").length && g.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")"), e.querySelectorAll("[selected]").length || g.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|" + O + ")"), e.querySelectorAll("[id~=" + w + "-]").length || g.push("~="), (t = f.createElement("input")).setAttribute("name", ""), e.appendChild(t), e.querySelectorAll("[name='']").length || g.push("\\[[\\x20\\t\\r\\n\\f]*name[\\x20\\t\\r\\n\\f]*=[\\x20\\t\\r\\n\\f]*(?:''|\"\")"), e.querySelectorAll(":checked").length || g.push(":checked"), e.querySelectorAll("a#" + w + "+*").length || g.push(".#.+[+~]"), e.querySelectorAll("\\\f"), g.push("[\\r\\n\\f]")
                    })), ue((function (e) {
                        e.innerHTML = "<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";
                        var t = f.createElement("input");
                        t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && g.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && g.push(":enabled", ":disabled"), m.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length && g.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), g.push(",.*:")
                    }))), (n.matchesSelector = K.test(v = m.matches || m.webkitMatchesSelector || m.mozMatchesSelector || m.oMatchesSelector || m.msMatchesSelector)) && ue((function (e) {
                        n.disconnectedMatch = v.call(e, "*"), v.call(e, "[s!='']:x"), y.push("!=", z)
                    })), g = g.length && new RegExp(g.join("|")), y = y.length && new RegExp(y.join("|")), t = K.test(m.compareDocumentPosition), b = t || K.test(m.contains) ? function (e, t) {
                        ...
                        return r || (1 & (r = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === r ? e == f || e.ownerDocument == T && b(T, e) ? -1 : t == f || t.ownerDocument == T && b(T, t) ? 1 : u ? D(u, e) - D(u, t) : 0 : 4 & r ? -1 : 1)
                    } : function (e, t) {
                        if (e === t) return d = !0, 0;
                        var n, r = 0,
                            i = e.parentNode,
                            ...
                            s = [e],
                            o = [t];
                        if (!i || !a) return e == f ? -1 : t == f ? 1 : i ? -1 : a ? 1 : u ? D(u, e) - D(u, t) : 0;
                        if (i === a) return pe(e, t);
                        for (n = e; n = n.parentNode;) s.unshift(n);
                        for (n = t; n = n.parentNode;) o.unshift(n);
                        for (; s[r] === o[r];) r++;
                        return r ? pe(s[r], o[r]) : s[r] == T ? -1 : o[r] == T ? 1 : 0
                    }, f) : f
                }, oe.matches = function (e, t) {
                    return oe(e, null, null, t)
                }, oe.matchesSelector = function (e, t) {
                    if (p(e), n.matchesSelector && h && !k[t + " "] && (!y || !y.test(t)) && (!g || !g.test(t))) try {
                        var r = v.call(e, t);
                    ...
                    var i = r.attrHandle[t.toLowerCase()],
                        a = i && _.call(r.attrHandle, t.toLowerCase()) ? i(e, t, !h) : void 0;
                    ...
                    var t, r = [],
                        i = 0,
                        a = 0;
                    if (d = !n.detectDuplicates, u = !n.sortStable && e.slice(0), e.sort(Y), d) {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function (e) {
                            var t, n = !e[6] && e[2];
                            return U.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && V.test(n) && (t = s(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                        }
                    },
                    filter: {
                        TAG: function (e) {
                        ...
                        CHILD: function (e, t, n, r, i) {
                            ...
                            return 1 === r && 0 === i ? function (e) {
                                ...
                                if (g) {
                                    ...
                                    if (m = [s ? g.firstChild : g.lastChild], s && v) {
                                        for (b = (f = (c = (u = (d = (p = g)[w] || (p[w] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] || [])[0] === x && c[1]) && c[2], p = f && g.childNodes[f]; p = ++f && p && p[h] || (b = f = 0) || m.pop();)
                                            if (1 === p.nodeType && ++b && p === t) {
                                                u[e] = [x, f, b];
                                                break
                                            }
                                    } else if (v && (b = f = (c = (u = (d = (p = t)[w] || (p[w] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] || [])[0] === x && c[1]), !1 === b)
                                        for (;
                                            (p = ++f && p && p[h] || (b = f = 0) || m.pop()) && ((o ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++b || (v && ((u = (d = p[w] || (p[w] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] = [x, b]), p !== t)););
                        ...
                        PSEUDO: function (e, t) {
                            ...
                            return i[w] ? i(t) : i.length > 1 ? (n = [e, e, "", t], r.setFilters.hasOwnProperty(e.toLowerCase()) ? ce((function (e, n) {
                                for (var r, a = i(e, t), s = a.length; s--;) e[r = D(e, a[s])] = !(n[r] = a[s])
                            })) : function (e) {
                                return i(e, 0, n)
                            }) : i
                        }
                    ...
                    pseudos: {
                        ...
                        lang: ce((function (e) {
                            return W.test(e || "") || oe.error("unsupported lang: " + e), e = e.replace(te, ne).toLowerCase(),
                                function (t) {
                                    var n;
                                    do {
                        ...
                        for (; t = t[r];)
                            if (1 === t.nodeType || s)
                                if (u = (d = t[w] || (t[w] = {}))[t.uniqueID] || (d[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t;
                                    ...
                                    if ((c = u[a]) && c[0] === x && c[1] === o) return p[2] = c[2];
            ...
            function Pe(e, t, n, r, i, a) {
                return r && !r[w] && (r = Pe(r)), i && !i[w] && (i = Pe(i, a)), ce((function (a, s, o, l) {
                    var c, u, d, p = [],
                        f = [],
                        m = s.length,
                        h = a || function (e, t, n) {
                        ...
                        g = !e || !a && t ? h : xe(h, p, e, o, l),
                        y = n ? i || (a ? e : m || r) ? [] : s : g;
                    if (n && n(g, y, o, l), r)
                        for (c = xe(y, f), r(c, [], o, l), u = c.length; u--;)(d = c[u]) && (y[f[u]] = !(g[f[u]] = d));
                    if (a) {
                        if (i || e) {
                            if (i) {
                            ...
                            for (u = y.length; u--;)(d = y[u]) && (c = i ? D(a, d) : p[u]) > -1 && (a[c] = !(s[c] = d))
                        }
                    } else y = xe(y === s ? y.splice(m, y.length) : y), i ? i(null, s, y, l) : $.apply(s, y)
                }))
            }
            ...
            function Ce(e) {
                for (var t, n, i, a = e.length, s = r.relative[e[0].type], o = s || r.relative[" "], l = s ? 1 : 0, u = we((function (e) {
                    ...
                    if (n = r.relative[e[l].type]) p = [we(Te(p), n)];
                    else {
                        if ((n = r.filter[e[l].type].apply(null, e[l].matches))[w]) {
                            for (i = ++l; i < a && !r.relative[e[i].type]; i++);
                            return Pe(l > 1 && Te(p), l > 1 && be(e.slice(0, l - 1).concat({
                                value: " " === e[l - 2].type ? "*" : ""
                            })).replace(F, "$1"), n, l < i && Ce(e.slice(l, i)), i < a && Ce(e = e.slice(i)), i < a && be(e))
                        }
                        p.push(n)
                    } return Te(p)
            }
            return ve.prototype = r.filters = r.pseudos, r.setFilters = new ve, s = oe.tokenize = function (e, t) {
                var n, i, a, s, o, l, c, u = S[e + " "];
                if (u) return t ? 0 : u.slice(0);
                for (o = e, l = [], c = r.preFilter; o;) {
                    for (s in n && !(i = N.exec(o)) || (i && (o = o.slice(i[0].length) || o), l.push(a = [])), n = !1, (i = q.exec(o)) && (n = i.shift(), a.push({
                            value: n,
                            type: i[0].replace(F, " ")
                        }), o = o.slice(n.length)), r.filter) !(i = U[s].exec(o)) || c[s] && !(i = c[s](i)) || (n = i.shift(), a.push({
                        value: n,
                        type: s,
                        matches: i
                    }), o = o.slice(n.length));
                ...
                var n, i = [],
                    ...
                    o = E[e + " "];
                if (!o) {
                    for (t || (t = s(e)), n = t.length; n--;)(o = Ce(t[n]))[w] ? i.push(o) : a.push(o);
                    o = E(e, function (e, t) {
                        var n = t.length > 0,
                            i = e.length > 0,
                            a = function (a, s, o, l, u) {
                                var d, m, g, y = 0,
                                    ...
                                    S = P.length;
                                for (u && (c = s == f || s || u); v !== S && null != (d = P[v]); v++) {
                                    if (i && d) {
                                        for (m = 0, s || d.ownerDocument == f || (p(d), o = !h); g = e[m++];)
                                            if (g(d, s || f, o)) {
                                                l.push(d);
                                                break
                                            } u && (x = C)
                                ...
                                if (y += v, n && v !== y) {
                                    for (m = 0; g = t[m++];) g(b, w, s, o);
                                    if (a) {
                                        if (y > 0)
                                            for (; v--;) b[v] || w[v] || (w[v] = M.call(l));
                                        w = xe(w)
                                    }
                                    $.apply(l, w), u && !a && w.length > 0 && y + t.length > 1 && oe.uniqueSort(l)
                                }
                                return u && (x = C, c = T), b
                            };
                        return n ? ce(a) : a
                ...
                if (n = n || [], 1 === f.length) {
                    if ((l = f[0] = f[0].slice(0)).length > 2 && "ID" === (c = l[0]).type && 9 === t.nodeType && h && r.relative[l[1].type]) {
                        if (!(t = (r.find.ID(c.matches[0].replace(te, ne), t) || [])[0])) return n;
                        p && (t = t.parentNode), e = e.slice(l.shift().value.length)
                    }
                    for (a = U.needsContext.test(e) ? 0 : l.length; a-- && (c = l[a], !r.relative[u = c.type]);)
                        if ((d = r.find[u]) && (i = d(c.matches[0].replace(te, ne), ee.test(l[0].type) && ye(t.parentNode) || t))) {
                            if (l.splice(a, 1), !(e = i.length && be(l))) return $.apply(n, i), n;
                            break
                        }
                }
                return (p || o(e, f))(i, t, !h, n, !t || ee.test(e) && ye(t.parentNode) || t), n
            }, n.sortStable = w.split("").sort(Y).join("") === w, n.detectDuplicates = !!d, p(), n.sortDetached = ue((function (e) {
    ...
    T.filter = function (e, t, n) {
        ...
        is: function (e) {
            return !!_(this, "string" == typeof e && E.test(e) ? T(e) : e || [], !1).length
        }
    });
    var j, M = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (T.fn.init = function (e, t, n) {
        ...
        if (n = n || j, "string" == typeof e) {
            ...
            if (r[1]) {
                if (t = t instanceof T ? t[0] : t, T.merge(this, T.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : g, !0)), Y.test(r[1]) && T.isPlainObject(t))
    ...
    T.fn.extend({
        ...
        contents: function (e) {
            return null != e.contentDocument && r(e.contentDocument) ? e.contentDocument : (k(e, "template") && (e = e.content || e), T.merge([], e.childNodes))
        }
    }, (function (e, t) {
        T.fn[e] = function (n, r) {
            var i = T.map(this, t, n);
            return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = T.filter(r, i)), this.length > 1 && ($[e] || T.uniqueSort(i), A.test(e) && i.reverse()), this.pushStack(i)
        }
    }));
    var D = /[^\x20\t\r\n\f]+/g;
    ...
    T.Callbacks = function (e) {
                ...
                add: function () {
                    return a && (n && !t && (o = a.length - 1, s.push(n)), function t(n) {
                        T.each(n, (function (n, r) {
                            m(r) ? e.unique && c.has(r) || a.push(r) : r && r.length && "string" !== b(r) && t(r)
                        }))
                                ...
                                var o = this,
                                    ...
                                    c = function () {
                                        ...
                                        if (!(t < a)) {
                                            ...
                                            c = e && ("object" == typeof e || "function" == typeof e) && e.then, m(c) ? i ? c.call(e, s(a, n, O, i), s(a, n, Q, i)) : (a++, c.call(e, s(a, n, O, i), s(a, n, Q, i), s(a, n, O, n.notifyWith))) : (r !== O && (o = void 0, l = [e]), (i || n.resolveWith)(o, l))
                                        }
                                    },
                                    u = i ? c : function () {
                                        try {
                                            ...
                                            T.Deferred.exceptionHook && T.Deferred.exceptionHook(e, u.stackTrace), t + 1 >= a && (r !== Q && (o = void 0, l = [e]), n.rejectWith(o, l))
                                        }
                                    };
                                t ? u() : (T.Deferred.getStackHook && (u.stackTrace = T.Deferred.getStackHook()), e.setTimeout(u))
                            }
                        }
                        return T.Deferred((function (e) {
                            n[0][3].add(s(0, e, m(i) ? i : O, e.notifyWith)), n[1][3].add(s(0, e, m(t) ? t : O)), n[2][3].add(s(0, e, m(r) ? r : Q))
                        })).promise()
                    },
                    promise: function (e) {
        ...
        when: function (e) {
            ...
            if (t <= 1 && (L(e, s.done(o(n)).resolve, s.reject, !t), "pending" === s.state() || m(a[n] && a[n].then))) return s.then();
            for (; n--;) L(a[n], o(n), s.reject);
            return s.promise()
        }
    });
    ...
    function R() {
        g.removeEventListener("DOMContentLoaded", R), e.removeEventListener("load", R), T.ready()
    }
    T.fn.ready = function (e) {
        ...
        readyWait: 1,
        ready: function (e) {
            (!0 === e ? --T.readyWait : T.isReady) || (T.isReady = !0, !0 !== e && --T.readyWait > 0 || z.resolveWith(g, [T]))
        }
    }), T.ready.then = z.then, "complete" === g.readyState || "loading" !== g.readyState && !g.documentElement.doScroll ? e.setTimeout(T.ready) : (g.addEventListener("DOMContentLoaded", R), e.addEventListener("load", R));
    ...
    function V(e) {
        return e.replace(N, "ms-").replace(q, H)
    }
    var W = function (e) {
    ...
    U.uid = 1, U.prototype = {
        ...
        remove: function (e, t) {
            ...
            if (void 0 !== r) {
                if (void 0 !== t) {
                    n = (t = Array.isArray(t) ? t.map(V) : (t = V(t)) in r ? [t] : t.match(D) || []).length;
                    for (; n--;) delete r[t[n]]
    ...
    T.extend({
        ...
        data: function (e, t) {
            var n, r, i, a = this[0],
                s = a && a.attributes;
            if (void 0 === e) {
                if (this.length && (i = G.get(a), 1 === a.nodeType && !X.get(a, "hasDataAttrs"))) {
                    for (n = s.length; n--;) s[n] && 0 === (r = s[n].name).indexOf("data-") && (r = V(r.slice(5)), J(a, r, i[r]));
            ...
            return "object" == typeof e ? this.each((function () {
                ...
                var n;
                if (a && void 0 === t) return void 0 !== (n = G.get(a, e)) || void 0 !== (n = J(a, e)) ? n : void 0;
                this.each((function () {
                    G.set(this, e, t)
                }))
        ...
        queue: function (e, t, n) {
            var r;
            if (e) return t = (t || "fx") + "queue", r = X.get(e, t), n && (!r || Array.isArray(n) ? r = X.access(e, t, T.makeArray(n)) : r.push(n)), r || []
        },
        ...
        promise: function (e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;)(n = X.get(a[s], e + "queueHooks")) && n.empty && (r++, n.empty.add(o));
    ...
    function oe(e, t, n, r) {
        ...
        if (u && u[3] !== c) {
            for (l /= 2, c = c || u[3], u = +l || 1; s--;) T.style(e, t, u + c), (1 - a) * (1 - (a = o() / l || .5)) <= 0 && (s = 0), u /= a;
    ...
    function ue(e, t) {
        for (var n, r, i = [], a = 0, s = e.length; a < s; a++)(r = e[a]).style && (n = r.style.display, t ? ("none" === n && (i[a] = X.get(r, "display") || null, i[a] || (r.style.display = "")), "" === r.style.display && se(r) && (i[a] = ce(r))) : "none" !== n && (i[a] = "none", X.set(r, "display", n)));
    ...
    function we(e, t, n, r, i) {
        for (var a, s, o, l, c, u, d = t.createDocumentFragment(), p = [], f = 0, m = e.length; f < m; f++)
            ...
            for (s = s || d.appendChild(t.createElement("div")), o = (me.exec(a) || ["", ""])[1].toLowerCase(), l = ge[o] || ge._default, s.innerHTML = l[1] + T.htmlPrefilter(a) + l[2], u = l[0]; u--;) s = s.lastChild;
            T.merge(p, s.childNodes), (s = d.firstChild).textContent = ""
        } else p.push(t.createTextNode(a));
        for (d.textContent = "", f = 0; a = p[f++];)
            if (r && T.inArray(a, r) > -1) i && i.push(a);
            else if (c = ie(a), s = ye(d.appendChild(a), "script"), c && ve(s), n)
    ...
    function Se(e, t, n, r, i, a) {
        ...
        }, i.guid = s.guid || (s.guid = T.guid++)), e.each((function () {
    ...
    function Ee(e, t, n) {
        n ? (X.set(e, t, !1), T.event.add(e, t, {
            namespace: !1,
            handler: function (e) {
                var r, a, s = X.get(this, t);
                if (1 & e.isTrigger && this[t]) {
                    if (s.length)(T.event.special[t] || {}).delegateType && e.stopPropagation();
                    else if (s = i.call(arguments), X.set(this, t, s), r = n(this, t), this[t](), s !== (a = X.get(this, t)) || r ? X.set(this, t, !1) : a = {}, s !== a) return e.stopImmediatePropagation(), e.preventDefault(), a && a.value
                } else s.length && (X.set(this, t, {
                    value: T.event.trigger(T.extend(s[0], T.Event.prototype), s.slice(1), this)
                }), e.stopImmediatePropagation())
            }
        })) : void 0 === X.get(e, t) && T.event.add(e, t, xe)
    }
    T.event = {
        global: {},
        add: function (e, t, n, r, i) {
            var a, s, o, l, c, u, d, p, f, m, h, g = X.get(e);
            if (W(e))
                for (n.handler && (n = (a = n).handler, i = a.selector), i && T.find.matchesSelector(re, i), n.guid || (n.guid = T.guid++), (l = g.events) || (l = g.events = Object.create(null)), (s = g.handle) || (s = g.handle = function (t) {
                        return void 0 !== T && T.event.triggered !== t.type ? T.event.dispatch.apply(e, arguments) : void 0
                    }), c = (t = (t || "").match(D) || [""]).length; c--;) f = h = (o = Te.exec(t[c]) || [])[1], m = (o[2] || "").split(".").sort(), f && (d = T.event.special[f] || {}, f = (i ? d.delegateType : d.bindType) || f, d = T.event.special[f] || {}, u = T.extend({
                    type: f,
                    origType: h,
                    data: r,
                    handler: n,
                    ...
                    namespace: m.join(".")
                }, a), (p = l[f]) || ((p = l[f] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(e, r, m, s) || e.addEventListener && e.addEventListener(f, s)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, u) : p.push(u), T.event.global[f] = !0)
        },
        remove: function (e, t, n, r, i) {
            var a, s, o, l, c, u, d, p, f, m, h, g = X.hasData(e) && X.get(e);
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(D) || [""]).length; c--;)
                    if (f = h = (o = Te.exec(t[c]) || [])[1], m = (o[2] || "").split(".").sort(), f) {
                        for (d = T.event.special[f] || {}, p = l[f = (r ? d.delegateType : d.bindType) || f] || [], o = o[2] && new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = a = p.length; a--;) u = p[a], !i && h !== u.origType || n && n.guid !== u.guid || o && !o.test(u.namespace) || r && r !== u.selector && ("**" !== r || !u.selector) || (p.splice(a, 1), u.selector && p.delegateCount--, d.remove && d.remove.call(e, u));
                        s && !p.length && (d.teardown && !1 !== d.teardown.call(e, m, g.handle) || T.removeEvent(e, f, g.handle), delete l[f])
                    } else
                        for (f in l) T.event.remove(e, f + t[c], n, r, !0);
            ...
            if (l.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, l)) {
                for (s = T.event.handlers.call(this, l, c), t = 0;
                    ...
                    for (l.currentTarget = i.elem, n = 0;
                        (a = i.handlers[n++]) && !l.isImmediatePropagationStopped();) l.rnamespace && !1 !== a.namespace && !l.rnamespace.test(a.namespace) || (l.handleObj = a, l.data = a.data, void 0 !== (r = ((T.event.special[a.origType] || {}).handle || a.handler).apply(i.elem, o)) && !1 === (l.result = r) && (l.preventDefault(), l.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === e.type && e.button >= 1))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        for (a = [], s = {}, n = 0; n < l; n++) void 0 === s[i = (r = t[n]).selector + " "] && (s[i] = r.needsContext ? T(i, this).index(c) > -1 : T.find(i, this, null, [c]).length), s[i] && a.push(r);
                        a.length && o.push({
                            elem: c,
                            handlers: a
                        })
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return fe.test(t.type) && t.click && k(t, "input") && Ee(t, "click", xe), !1
                },
                trigger: function (e) {
                    var t = this || e;
                    return fe.test(t.type) && t.click && k(t, "input") && Ee(t, "click"), !0
                },
                _default: function (e) {
                    var t = e.target;
                    return fe.test(t.type) && t.click && k(t, "input") && X.get(t, "click") || k(t, "a")
                }
            },
            beforeunload: {
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? xe : Pe, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && T.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[T.expando] = !0
    }, T.Event.prototype = {
        constructor: T.Event,
        ...
        T.event.special[e] = {
            ...
            handle: function (e) {
                var n, r = this,
                    i = e.relatedTarget,
                    a = e.handleObj;
                return i && (i === r || T.contains(r, i)) || (e.type = a.origType, n = a.handler.apply(this, arguments), e.type = t), n
            }
        }
    })), T.fn.extend({
        on: function (e, t, n, r) {
        ...
        if (1 === t.nodeType) {
            if (X.hasData(e) && (o = X.get(e).events))
                for (i in X.remove(t, "handle events"), o)
                    for (n = 0, r = o[i].length; n < r; n++) T.event.add(t, i, o[i][n]);
            G.hasData(e) && (a = G.access(e), s = T.extend({}, a), G.set(t, s))
        }
    }
    ...
    function De(e, t, n, r) {
        ...
        var i, s, o, l, c, u, d = 0,
            ...
            g = t[0],
            y = m(g);
        if (y || p > 1 && "string" == typeof g && !f.checkClone && Ye.test(g)) return e.each((function (i) {
            var a = e.eq(i);
            y && (t[0] = g.call(this, i, a.html())), De(a, t, n, r)
        }));
        if (p && (s = (i = we(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = s), s || r)) {
            for (l = (o = T.map(ye(i, "script"), Me)).length; d < p; d++) c = i, d !== h && (c = T.clone(c, !0, !0), l && T.merge(o, ye(c, "script"))), n.call(e[d], c, d);
            if (l)
                for (u = o[o.length - 1].ownerDocument, T.map(o, Ae), d = 0; d < l; d++) c = o[d], he.test(c.type || "") && !X.access(c, "globalEval") && T.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? T._evalUrl && !c.noModule && T._evalUrl(c.src, {
                    nonce: c.nonce || c.getAttribute("nonce")
                }, u) : v(c.textContent.replace(_e, ""), c, u))
        }
        return e
    }

    function Oe(e, t, n) {
        for (var r, i = t ? T.filter(t, e) : e, a = 0; null != (r = i[a]); a++) n || 1 !== r.nodeType || T.cleanData(ye(r)), r.parentNode && (n && ie(r) && ve(ye(r, "script")), r.parentNode.removeChild(r));
        return e
    }
    T.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(f.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || T.isXMLDoc(e)))
                for (s = ye(o), r = 0, i = (a = ye(e)).length; r < i; r++) Ie(a[r], s[r]);
            if (t)
                if (n)
                    for (a = a || ye(e), s = s || ye(o), r = 0, i = a.length; r < i; r++) $e(a[r], s[r]);
                else $e(e, o);
            return (s = ye(o, "script")).length > 0 && ve(s, !l && ye(e, "script")), o
        },
        cleanData: function (e) {
            for (var t, n, r, i = T.event.special, a = 0; void 0 !== (n = e[a]); a++)
                if (W(n)) {
                    if (t = n[X.expando]) {
                        if (t.events)
        ...
        html: function (e) {
            return F(this, (function (e) {
                ...
                if ("string" == typeof e && !ke.test(e) && !ge[(me.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = T.htmlPrefilter(e);
                    try {
        ...
        T.fn[e] = function (e) {
            for (var n, r = [], i = T(e), a = i.length - 1, o = 0; o <= a; o++) n = o === a ? this : this.clone(!0), T(i[o])[t](n), s.apply(r, n.get());
    ...
    function Re(e, t, n) {
        ...
        return (n = n || Le(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || ie(e) || (s = T.style(e, t)), !f.pixelBoxStyles() && Qe.test(s) && ze.test(t) && (r = o.width, i = o.minWidth, a = o.maxWidth, o.minWidth = o.maxWidth = o.width = s, s = n.width, o.width = r, o.minWidth = i, o.maxWidth = a)), void 0 !== s ? s + "" : s
    }
    ...
    function Fe(e, t) {
        ...
        u.style && (u.style.backgroundClip = "content-box", u.cloneNode(!0).style.backgroundClip = "", f.clearCloneStyle = "content-box" === u.style.backgroundClip, T.extend(f, {
    ...
    function Ve(e) {
        return T.cssProps[e] || He[e] || (e in qe ? e : He[e] = function (e) {
    ...
    function Ke(e, t, n, r, i, a) {
        ...
        for (; s < 4; s += 2) "margin" === n && (l += T.css(e, n + ne[s], !0, i)), r ? ("content" === n && (l -= T.css(e, "padding" + ne[s], !0, i)), "margin" !== n && (l -= T.css(e, "border" + ne[s] + "Width", !0, i))) : (l += T.css(e, "padding" + ne[s], !0, i), "padding" !== n ? l += T.css(e, "border" + ne[s] + "Width", !0, i) : o += T.css(e, "border" + ne[s] + "Width", !0, i));
        return !r && a >= 0 && (l += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - a - l - o - .5)) || 0), l
    }

    function Je(e, t, n) {
        var r = Le(e),
            i = (!f.boxSizingReliable() || n) && "border-box" === T.css(e, "boxSizing", !1, r),
            a = i,
            s = Re(e, t, r),
        ...
        return (!f.boxSizingReliable() && i || !f.reliableTrDimensions() && k(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === T.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === T.css(e, "boxSizing", !1, r), (a = o in e) && (s = e[o])), (s = parseFloat(s) || 0) + Ke(e, t, n || (i ? "border" : "content"), a, r, s) + "px"
    }
    ...
    T.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, a, s, o = V(t),
                    l = Ue.test(t),
                    c = e.style;
                if (l || (t = Ve(o)), s = T.cssHooks[t] || T.cssHooks[o], void 0 === n) return s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : c[t];
                "string" == (a = typeof n) && (i = te.exec(n)) && i[1] && (n = oe(e, t, i), a = "number"), null != n && n == n && ("number" !== a || l || (n += i && i[3] || (T.cssNumber[o] ? "" : "px")), f.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function (e, t, n, r) {
            var i, a, s, o = V(t);
            return Ue.test(t) || (t = Ve(o)), (s = T.cssHooks[t] || T.cssHooks[o]) && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = Re(e, t, r)), "normal" === i && t in Ge && (i = Ge[t]), "" === n || n ? (a = parseFloat(i), !0 === n || isFinite(a) ? a || 0 : i) : i
        }
    }), T.each(["height", "width"], (function (e, t) {
        T.cssHooks[t] = {
            get: function (e, n, r) {
                if (n) return !We.test(T.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Je(e, t, r) : Be(e, Xe, (function () {
                    return Je(e, t, r)
                }))
            },
            set: function (e, n, r) {
                var i, a = Le(e),
                    ...
                    o = (s || r) && "border-box" === T.css(e, "boxSizing", !1, a),
                    l = r ? Ke(e, t, r, o, a) : 0;
                return o && s && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(a[t]) - Ke(e, t, "border", !1, a) - .5)), l && (i = te.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = T.css(e, t)), Ze(0, n, l)
            }
        }
    })), T.cssHooks.marginLeft = Fe(f.reliableMarginLeft, (function (e, t) {
        ...
        css: function (e, t) {
            return F(this, (function (e, t, n) {
                var r, i, a = {},
                    s = 0;
                if (Array.isArray(t)) {
                    for (r = Le(e), i = t.length; s < i; s++) a[t[s]] = T.css(e, t[s], !1, r);
                    return a
                }
        ...
        init: function (e, t, n, r, i, a) {
            this.elem = e, this.prop = n, this.easing = i || T.easing._default, this.options = t, this.start = this.now = this.cur(), this.end = r, this.unit = a || (T.cssNumber[n] ? "" : "px")
        },
        cur: function () {
    ...
    function at() {
        nt && (!1 === g.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(at) : e.setTimeout(at, T.fx.interval), T.fx.tick())
    }
    ...
    function ct(e, t, n) {
        ...
        for (function (e, t) {
                var n, r, i, a, s;
                for (n in e)
                    if (i = t[r = V(n)], a = e[n], Array.isArray(a) && (i = a[1], a = e[n] = a[0]), n !== r && (e[r] = a, delete e[n]), (s = T.cssHooks[r]) && "expand" in s)
                        for (n in a = s.expand(a), delete e[r], a) n in e || (e[n] = a[n], t[n] = i);
                    else t[r] = i
            }(u, c.opts.specialEasing); a < s; a++)
            if (r = ct.prefilters[a].call(c, e, u, c.opts)) return m(r.stop) && (T._queueHooks(c.elem, c.opts.queue).stop = r.stop.bind(r)), r;
    ...
    T.Animation = T.extend(ct, {
            ...
            prefilters: [function (e, t, n) {
                var r, i, a, s, o, l, c, u, d = "width" in t || "height" in t,
                    ...
                    h = e.nodeType && se(e),
                    g = X.get(e, "fxshow");
                for (r in n.queue || (null == (s = T._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, o = s.empty.fire, s.empty.fire = function () {
                        s.unqueued || o()
                    ...
                    for (r in d && 1 === e.nodeType && (n.overflow = [m.overflow, m.overflowX, m.overflowY], null == (c = g && g.display) && (c = X.get(e, "display")), "none" === (u = T.css(e, "display")) && (c ? u = c : (ue([e], !0), c = e.style.display || c, u = T.css(e, "display"), ue([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === T.css(e, "float") && (l || (p.done((function () {
                            m.display = c
                        ...
                        }))), l = !1, f) l || (g ? "hidden" in g && (h = g.hidden) : g = X.access(e, "fxshow", {
                        display: c
                    }), a && (g.hidden = !h), h && ue([e], !0), p.done((function () {
                        for (r in h || ue([e]), X.remove(e, "fxshow"), f) T.style(e, r, f[r])
                    }))), l = lt(h ? g[r] : 0, r, p), r in g || (g[r] = l.start, h && (l.end = l.start, l.start = 0))
            }],
    ...
    T.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            if (3 !== a && 8 !== a && 2 !== a) return void 0 === e.getAttribute ? T.prop(e, t, n) : (1 === a && T.isXMLDoc(e) || (i = T.attrHooks[t.toLowerCase()] || (T.expr.match.bool.test(t) ? ut : void 0)), void 0 !== n ? null === n ? void T.removeAttr(e, t) : i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : i && "get" in i && null !== (r = i.get(e, t)) ? r : null == (r = T.find.attr(e, t)) ? void 0 : r)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
    ...
    T.fn.extend({
        ...
        prop: function (e, t, n) {
            var r, i, a = e.nodeType;
            if (3 !== a && 8 !== a && 2 !== a) return 1 === a && T.isXMLDoc(e) || (t = T.propFix[t] || t, i = T.propHooks[t]), void 0 !== n ? i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : e[t] = n : i && "get" in i && null !== (r = i.get(e, t)) ? r : e[t]
        },
        propHooks: {
            tabIndex: {
                get: function (e) {
        ...
        addClass: function (e) {
            ...
            if (m(e)) return this.each((function (t) {
                T(this).addClass(e.call(this, t, ht(this)))
            }));
            if ((t = gt(e)).length)
                for (; n = this[l++];)
                    if (i = ht(n), r = 1 === n.nodeType && " " + mt(i) + " ") {
        ...
        removeClass: function (e) {
            var t, n, r, i, a, s, o, l = 0;
            if (m(e)) return this.each((function (t) {
                T(this).removeClass(e.call(this, t, ht(this)))
            }));
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : m(e) ? this.each((function (n) {
                T(this).toggleClass(e.call(this, n, ht(this), t), t)
            })) : this.each((function () {
                var t, i, a, s;
                if (r)
                    for (i = 0, a = T(this), s = gt(e); t = s[i++];) a.hasClass(t) ? a.removeClass(t) : a.addClass(t);
        ...
        hasClass: function (e) {
            var t, n, r = 0;
            for (t = " " + e + " "; n = this[r++];)
                if (1 === n.nodeType && (" " + mt(ht(n)) + " ").indexOf(t) > -1) return !0;
            return !1
        }
    });
    var yt = /\r/g;
            ...
            select: {
                get: function (e) {
                    ...
                    for (r = a < 0 ? l : s ? a : 0; r < l; r++)
                        if (((n = i[r]).selected || r === a) && !n.disabled && (!n.parentNode.disabled || !k(n.parentNode, "optgroup"))) {
                            if (t = T(n).val(), s) return t;
                            o.push(t)
                        } return o
                },
                set: function (e, t) {
                    for (var n, r, i = e.options, a = T.makeArray(t), s = i.length; s--;)((r = i[s]).selected = T.inArray(T.valHooks.option.get(r), a) > -1) && (n = !0);
    ...
    T.extend(T.event, {
        trigger: function (t, n, r, i) {
            var a, s, o, l, c, d, p, f, y = [r || g],
                v = u.call(t, "type") ? t.type : t,
                b = u.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = f = o = r = r || g, 3 !== r.nodeType && 8 !== r.nodeType && !vt.test(v + T.event.triggered) && (v.indexOf(".") > -1 && (b = v.split("."), v = b.shift(), b.sort()), c = v.indexOf(":") < 0 && "on" + v, (t = t[T.expando] ? t : new T.Event(v, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : T.makeArray(n, [t]), p = T.event.special[v] || {}, i || !p.trigger || !1 !== p.trigger.apply(r, n))) {
                if (!i && !p.noBubble && !h(r)) {
                    for (l = p.delegateType || v, vt.test(l + v) || (s = s.parentNode); s; s = s.parentNode) y.push(s), o = s;
                    o === (r.ownerDocument || g) && y.push(o.defaultView || o.parentWindow || e)
                }
                for (a = 0;
                    (s = y[a++]) && !t.isPropagationStopped();) f = s, t.type = a > 1 ? l : p.bindType || v, (d = (X.get(s, "events") || Object.create(null))[t.type] && X.get(s, "handle")) && d.apply(s, n), (d = c && s[c]) && d.apply && W(s) && (t.result = d.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = v, i || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(y.pop(), n) || !W(r) || c && m(r[v]) && !h(r) && ((o = r[c]) && (r[c] = null), T.event.triggered = v, t.isPropagationStopped() && f.addEventListener(v, bt), r[v](), t.isPropagationStopped() && f.removeEventListener(v, bt), T.event.triggered = void 0, o && (r[c] = o)), t.result
            }
        },
    ...
    function kt(e, t, n, r) {
        ...
        if (Array.isArray(t)) T.each(t, (function (t, i) {
            n || Pt.test(e) ? r(e, i) : kt(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, r)
        }));
    ...
    T.param = function (e, t) {
        ...
        serializeArray: function () {
            return this.map((function () {
                ...
                var e = this.type;
                return this.name && !T(this).is(":disabled") && Et.test(this.nodeName) && !St.test(e) && (this.checked || !fe.test(e))
            })).map((function (e, t) {
                var n = T(this).val();
    ...
    Qt.href = wt.href, T.extend({
        ...
        ajax: function (t, n) {
            ...
            var r, i, a, s, o, l, c, u, d, p, f = T.ajaxSetup({}, n),
                m = f.context || f,
            ...
            if (y.promise(C), f.url = ((t || f.url || wt.href) + "").replace($t, wt.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(D) || [""], null == f.crossDomain) {
                l = g.createElement("a");
                try {
            ...
            if (f.data && f.processData && "string" != typeof f.data && (f.data = T.param(f.data, f.traditional)), Bt(It, f, n, C), c) return C;
            for (d in (u = T.event && f.global) && 0 == T.active++ && T.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !At.test(f.type), i = f.url.replace(_t, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Yt, "+")) : (p = f.url.slice(i.length), f.data && (f.processData || "string" == typeof f.data) && (i += (xt.test(i) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (i = i.replace(jt, "$1"), p = (xt.test(i) ? "&" : "?") + "_=" + Tt.guid++ + p), f.url = i + p), f.ifModified && (T.lastModified[i] && C.setRequestHeader("If-Modified-Since", T.lastModified[i]), T.etag[i] && C.setRequestHeader("If-None-Match", T.etag[i])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && C.setRequestHeader("Content-Type", f.contentType), C.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Ot + "; q=0.01" : "") : f.accepts["*"]), f.headers) C.setRequestHeader(d, f.headers[d]);
            if (f.beforeSend && (!1 === f.beforeSend.call(m, C, f) || c)) return C.abort();
            if (P = "abort", v.add(f.complete), C.done(f.success), C.fail(f.error), r = Bt(Dt, f, n, C)) {
            ...
            function S(t, n, s, l) {
                var d, p, g, w, x, P = n;
                c || (c = !0, o && e.clearTimeout(o), r = void 0, a = l || "", C.readyState = t > 0 ? 4 : 0, d = t >= 200 && t < 300 || 304 === t, s && (w = function (e, t, n) {
                ...
                }(f, C, s)), !d && T.inArray("script", f.dataTypes) > -1 && T.inArray("json", f.dataTypes) < 0 && (f.converters["text script"] = function () {}), w = function (e, t, n, r) {
                    var i, a, s, o, l, c = {},
                        u = e.dataTypes.slice();
                    if (u[1])
                ...
                }(f, w, C, d), d ? (f.ifModified && ((x = C.getResponseHeader("Last-Modified")) && (T.lastModified[i] = x), (x = C.getResponseHeader("etag")) && (T.etag[i] = x)), 204 === t || "HEAD" === f.type ? P = "nocontent" : 304 === t ? P = "notmodified" : (P = w.state, p = w.data, d = !(g = w.error))) : (g = P, !t && P || (P = "error", t < 0 && (t = 0))), C.status = t, C.statusText = (n || P) + "", d ? y.resolveWith(m, [p, P, C]) : y.rejectWith(m, [C, P, g]), C.statusCode(b), b = void 0, u && h.trigger(d ? "ajaxSuccess" : "ajaxError", [C, f, d ? p : g]), v.fireWith(m, [C, P]), u && (h.trigger("ajaxComplete", [C, f]), --T.active || T.event.trigger("ajaxStop")))
            }
            return C
        },
    ...
    f.cors = !!Ft && "withCredentials" in Ft, f.ajax = Ft = !!Ft, T.ajaxTransport((function (t) {
        var n, r;
        if (f.cors || Ft && !t.crossDomain) return {
            send: function (i, a) {
                ...
                n = function (e) {
                    return function () {
                        n && (n = r = o.onload = o.onerror = o.onabort = o.ontimeout = o.onreadystatechange = null, "abort" === e ? o.abort() : "error" === e ? "number" != typeof o.status ? a(0, "error") : a(o.status, o.statusText) : a(Rt[o.status] || o.status, o.statusText, "text" !== (o.responseType || "text") || "string" != typeof o.responseText ? {
                            binary: o.response
                        } : {
                            text: o.responseText
    ...
    T.ajaxSetup({
        ...
        var i, a, s, o = !1 !== t.jsonp && (Ht.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Ht.test(t.data) && "data");
        if (o || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = m(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, o ? t[o] = t[o].replace(Ht, "$1" + i) : !1 !== t.jsonp && (t.url += (xt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
            return s || T.error(i + " was not called"), s[0]
        }, t.dataTypes[0] = "json", a = e[i], e[i] = function () {
            s = arguments
        }, r.always((function () {
            void 0 === a ? T(e).removeProp(i) : e[i] = a, t[i] && (t.jsonpCallback = n.jsonpCallback, qt.push(i)), s && m(a) && a(s[0]), s = a = void 0
        })), "script"
    })), f.createHTMLDocument = ((Nt = g.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Nt.childNodes.length), T.parseHTML = function (e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (f.createHTMLDocument ? ((r = (t = g.implementation.createHTMLDocument("")).createElement("base")).href = g.location.href, t.head.appendChild(r)) : t = g), a = !n && [], (i = Y.exec(e)) ? [t.createElement(i[1])] : (i = we([e], t, a), a && a.length && T(a).remove(), T.merge([], i.childNodes)));
        var r, i, a
    }, T.fn.load = function (e, t, n) {
        var r, i, a, s = this,
            o = e.indexOf(" ");
        return o > -1 && (r = mt(e.slice(o)), e = e.slice(0, o)), m(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), s.length > 0 && T.ajax({
            url: e,
            type: i || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function (e, t, n) {
            var r, i, a, s, o, l, c = T.css(e, "position"),
                u = T(e),
                d = {};
            "static" === c && (e.style.position = "relative"), o = u.offset(), a = T.css(e, "top"), l = T.css(e, "left"), ("absolute" === c || "fixed" === c) && (a + l).indexOf("auto") > -1 ? (s = (r = u.position()).top, i = r.left) : (s = parseFloat(a) || 0, i = parseFloat(l) || 0), m(t) && (t = t.call(e, n, T.extend({}, o))), null != t.top && (d.top = t.top - o.top + s), null != t.left && (d.left = t.left - o.left + i), "using" in t ? t.using.call(e, d) : u.css(d)
        }
    }, T.fn.extend({
        offset: function (e) {
        ...
        T.fn[e] = function (r) {
            return F(this, (function (e, r, i) {
                var a;
                if (h(e) ? a = e : 9 === e.nodeType && (a = e.defaultView), void 0 === i) return a ? a[t] : e[r];
                a ? a.scrollTo(n ? a.pageXOffset : i, n ? i : a.pageYOffset) : e[r] = i
            }), e, r, arguments.length)
        }
    })), T.each(["top", "left"], (function (e, t) {
        T.cssHooks[t] = Fe(f.pixelPosition, (function (e, n) {
        ...
        T.each({
            ...
            T.fn[r] = function (i, a) {
                ...
                return F(this, (function (t, n, i) {
                    var a;
                    return h(t) ? 0 === r.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (a = t.documentElement, Math.max(t.body["scroll" + e], a["scroll" + e], t.body["offset" + e], a["offset" + e], a["client" + e])) : void 0 === i ? T.css(t, n, o) : T.style(t, n, i, o)
                }), t, s ? i : void 0, s)
            }
        }))
    ...
    T.proxy = function (e, t) {
        var n, r, a;
        if ("string" == typeof t && (n = e[t], t = e, e = n), m(e)) return r = i.call(arguments, 2), a = function () {
            return e.apply(t || this, r.concat(i.call(arguments)))
        }, a.guid = e.guid = e.guid || T.guid++, a
    }, T.holdReady = function (e) {
        e ? T.readyWait++ : T.ready(!0)
    }, T.isArray = Array.isArray, T.parseJSON = JSON.parse, T.nodeName = k, T.isFunction = m, T.isWindow = h, T.camelCase = V, T.type = b, T.now = Date.now, T.isNumeric = function (e) {
        var t = T.type(e);
    ...
    return T.noConflict = function (t) {
        return e.$ === T && (e.$ = Ut), t && e.jQuery === T && (e.jQuery = Wt), T
...
window.Modernizr = function (e, t, n) {
        ...
        function o(e, t, r) {
            for (var a in e) {
                var s = t[e[a]];
                if (s !== n) return !1 === r ? e[a] : i(s, "function") ? s.bind(r || t) : s
            }
            return !1
        }
        ...
        function l(e, t, n) {
            ...
            return i(t, "string") || i(t, "undefined") ? s(a, t) : o(a = (e + " " + x.join(r + " ") + r).split(" "), t, n)
        }
        var c, u, d = {},
            p = t.documentElement,
            f = "modernizr",
            ...
            _ = function (e, n, r, i) {
                ...
                if (parseInt(r, 10))
                    for (; r--;)(o = t.createElement("div")).id = i ? i[r] : f + (r + 1), c.appendChild(o);
            ...
            j = function () {
                ...
                return function (r, a) {
                    a = a || t.createElement(e[r] || "div");
                    var s = (r = "on" + r) in a;
                    return s || (a.setAttribute || (a = t.createElement("div")), a.setAttribute && a.removeAttribute && (a.setAttribute(r, ""), s = i(a[r], "function"), i(a[r], "undefined") || (a[r] = n), a.removeAttribute(r))), a = null, s
                }
            }(),
            M = {}.hasOwnProperty;
        for (var A in u = i(M, "undefined") || i(M.call, "undefined") ? function (e, t) {
                ...
                var n = Y.call(arguments, 1),
                    r = function () {
                        if (this instanceof r) {
                            ...
                            var a = new i,
                                s = t.apply(a, n.concat(Y.call(arguments)));
                ...
                var n;
                return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : _(["@media (", b.join("touch-enabled),("), f, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), (function (e) {
                    n = 9 === e.offsetTop
                })), n
                ...
                return r("background-color:rgba(150,255,150,.5)"), a(h.backgroundColor, "rgba")
            }, C.hsla = function () {
                return r("background-color:hsla(120,40%,100%,.5)"), a(h.backgroundColor, "rgba") || a(h.backgroundColor, "hsla")
                ...
                return r(b.join("opacity:.55;") + ""), /^0.55$/.test(h.opacity)
                ...
                return r((e + "-webkit- ".split(" ").join("gradient(linear,left top,right bottom,from(#9f9),to(white));" + e) + b.join("linear-gradient(left top,#9f9, white);" + e)).slice(0, -e.length)), a(h.backgroundImage, "gradient")
                ...
                var e = !!l("perspective");
                return e && "webkitPerspective" in p.style && _("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", (function (t) {
                ...
                var e;
                return _(["#", f, "{font:0/0 a}#", f, ':after{content:"', y, '";visibility:hidden;font:3px/1 a}'].join(""), (function (t) {
                    e = t.offsetHeight >= 3
                })), e
            }, C.video = function () {
                ...
                var e = t.createElement("div");
                return e.innerHTML = "<svg/>", (e.firstChild && e.firstChild.namespaceURI) == P
            }, C.smil = function () {
            ...
            }, C) u(C, A) && (c = A.toLowerCase(), d[c] = C[A](), k.push((d[c] ? "" : "no-") + c));
        return d.input || (d.input = function (n) {
                for (var r = 0, i = n.length; i > r; r++) E[n[r]] = !!(n[r] in g);
            ...
            function (e, t) {
                ...
                function i(e, n, i) {
                    return n || (n = t), l ? n.createElement(e) : (i || (i = r(n)), !(a = i.cache[e] ? i.cache[e].cloneNode() : d.test(e) ? (i.cache[e] = i.createElem(e)).cloneNode() : i.createElem(e)).canHaveChildren || u.test(e) || a.tagUrn ? a : i.frag.appendChild(a));
                    var a
                }
                ...
                function s(e) {
                    ...
                    return !h.shivCSS || o || n.hasCSS || (n.hasCSS = !! function (e, t) {
                        ...
                        return n.innerHTML = "x<style>article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}</style>", r.insertBefore(n.lastChild, r.firstChild)
                    }(e)), l || a(e, n), e
                }
                var o, l, c = e.html5 || {},
                ...
                var h = {
                    ...
                    createDocumentFragment: function (e, i) {
                        ...
                        for (var a = (i = i || r(e)).frag.cloneNode(), s = 0, o = n(), c = o.length; c > s; s++) a.createElement(o[s]);
                        return a
                    }
                };
                e.html5 = h, s(t)
            }(this, t), d._version = "2.8.3", d._prefixes = b, d._domPrefixes = x, d._cssomPrefixes = T, d.mq = function (t) {
                var n, r = e.matchMedia || e.msMatchMedia;
                return r ? r(t) && r(t).matches || !1 : (_("@media " + t + " { #" + f + " { position: absolute; } }", (function (t) {
                    n = "absolute" == (e.getComputedStyle ? getComputedStyle(t, null) : t.currentStyle).position
                })), n)
            }, d.hasEvent = j, d.testProp = function (e) {
                return s([e])
            }, d.testAllProps = l, d.testStyles = _, d.prefixed = function (e, t, n) {
                        ...
                        value: function (e, t) {
                            ...
                            !0 !== this.pause.status ? this.timeout = setTimeout((function () {
                                ...
                                if ("^" === s.charAt(0) && /^\^\d+/.test(s)) {
                                    var o = 1;
                                    o += (s = /\d+/.exec(s)[0]).length, r = parseInt(s), n.temporaryPause = !0, n.options.onTypingPaused(n.arrayPos, n), e = e.substring(0, t) + e.substring(t + o), n.toggleBlinking(!0)
                                }
                                if ("`" === s.charAt(0)) {
                                    for (;
                                        "`" !== e.substr(t + i).charAt(0) && (i++, !(t + i > e.length)););
                                    var l = e.substring(0, t),
                                        c = e.substring(l.length + 1, t + i),
                                        u = e.substring(t + i + 1);
                                    e = l + c + u, i--
                                }
    ...
    function () {
        ...
        window.JQClass = function () {}, JQClass.classes = {}, JQClass.extend = function t(n) {
            ...
            var a = new this;
            for (var s in e = !1, n)
                if ("function" == typeof n[s] && "function" == typeof i[s]) a[s] = function (e, t) {
                    return function () {
                        var n = this._super;
                ...
                else if ("object" == typeof n[s] && "object" == typeof i[s] && "defaultOptions" === s) {
                var o, l = i[s],
                    c = n[s],
                    u = {};
                for (o in l) u[o] = l[o];
    ...
    function ($) {
        ...
        JQClass.classes.JQPlugin = JQClass.extend({
            ...
            option: function (e, t, n) {
                var r = (e = $(e)).data(this.name),
                    i = t || {};
                return !t || "string" == typeof t && void 0 === n ? (i = (r || {}).options) && t ? i[t] : i : void(e.hasClass(this._getMarker()) && ("string" == typeof t && (i = {}, i[t] = n), this._optionsChanged(e, r, i), $.extend(r.options, i)))
            },
        ...
        e.JQPlugin.createPlugin({
            ...
            _init: function () {
                ...
                var n = "function" == typeof Date.now ? Date.now : function () {
                    ...
                    a = 0;
                !i || e.noRequestAnimationFrame ? (e.noRequestAnimationFrame = null, e.countdown._timer = setInterval((function () {
                    t._updateElems()
                }), 1e3)) : (a = window.animationStartTime || window.webkitAnimationStartTime || window.mozAnimationStartTime || window.oAnimationStartTime || window.msAnimationStartTime || n(), i((function e(s) {
                    var o = s < 1e12 ? r ? window.performance.now() + window.performance.timing.navigationStart : n() : s || n();
                    o - a >= 1e3 && (t._updateElems(), a = o), i(e)
                })))
            },
            UTCDate: function (e, t, n, r, i, a, s, o) {
                "object" == typeof t && t instanceof Date && (o = t.getMilliseconds(), s = t.getSeconds(), a = t.getMinutes(), i = t.getHours(), r = t.getDate(), n = t.getMonth(), t = t.getFullYear());
                var l = new Date;
                return l.setUTCFullYear(t), l.setUTCDate(1), l.setUTCMonth(n || 0), l.setUTCDate(r || 1), l.setUTCHours(i || 0), l.setUTCMinutes((a || 0) - (Math.abs(e) < 30 ? 60 * e : e)), l.setUTCSeconds(s || 0), l.setUTCMilliseconds(o || 0), l
            },
            ...
            resync: function () {
                ...
                e("." + this._getMarker()).each((function () {
                    ...
                    if (n.options.serverSync) {
                        for (var r = null, i = 0; i < t._serverSyncs.length; i++)
                            if (t._serverSyncs[i][0] === n.options.serverSync) {
                                r = t._serverSyncs[i];
                                break
                            } if (t._eqNull(r[2])) {
                            var a = e.isFunction(n.options.serverSync) ? n.options.serverSync.apply(this, []) : null;
                            r[2] = (a ? (new Date).getTime() - a.getTime() : 0) - r[1]
                        }
            ...
            _optionsChanged: function (t, n, r) {
                ...
                e.extend(n.options, r), this._adjustSettings(t, n, !this._eqNull(r.until) || !this._eqNull(r.since) || i);
                var a = new Date;
            ...
            _updateCountdown: function (t, n) {
                if (t = t.jquery ? t : e(t), n = n || this._getInst(t)) {
                    if (t.html(this._generateHTML(n)).toggleClass(this._rtlClass, n.options.isRTL), "pause" !== n._hold && e.isFunction(n.options.onTick)) {
                        ...
                        1 !== n.options.tickInterval && this.periodsToSeconds(r) % n.options.tickInterval != 0 || n.options.onTick.apply(t[0], [r])
                    }
                    if ("pause" !== n._hold && (n._since ? n._now.getTime() < n._since.getTime() : n._now.getTime() >= n._until.getTime()) && !n._expiring) {
                        if (n._expiring = !0, this._hasElem(t[0]) || n.options.alwaysExpire) {
                            if (this._removeElem(t[0]), e.isFunction(n.options.onExpiry) && n.options.onExpiry.apply(t[0], []), n.options.expiryText) {
                                ...
                                n.options.layout = n.options.expiryText, this._updateCountdown(t[0], n), n.options.layout = i
                            }
            ...
            _adjustSettings: function (t, n, r) {
                for (var i = null, a = 0; a < this._serverSyncs.length; a++)
                    if (this._serverSyncs[a][0] === n.options.serverSync) {
                        i = this._serverSyncs[a][1];
                        break
                    } var s = null,
                    o = null;
                if (this._eqNull(i)) {
                ...
                } else s = new Date, o = n.options.serverSync ? i : 0;
                var c = n.options.timezone;
                c = this._eqNull(c) ? -s.getTimezoneOffset() : c, (r || !r && this._eqNull(n._until) && this._eqNull(n._since)) && (n._since = n.options.since, this._eqNull(n._since) || (n._since = this.UTCDate(c, this._determineTime(n._since, null)), n._since && o && n._since.setMilliseconds(n._since.getMilliseconds() + o)), n._until = this.UTCDate(c, this._determineTime(n.options.until, s)), o && n._until.setMilliseconds(n._until.getMilliseconds() + o)), n._show = this._determineShow(n)
            },
            _preDestroy: function (e, t) {
            ...
            _hold: function (t, n) {
                ...
                if (r) {
                    if ("pause" === r._hold && !n) {
                        ...
                        var i = r._since ? "-" : "+";
                        r[r._since ? "_since" : "_until"] = this._determineTime(i + r._periods[0] + "y" + i + r._periods[1] + "o" + i + r._periods[2] + "w" + i + r._periods[3] + "d" + i + r._periods[4] + "h" + i + r._periods[5] + "m" + i + r._periods[6] + "s"), this._addElem(t)
                    }
                    r._hold = n, r._savePeriods = "pause" === n ? r._periods : null, e.data(t, this.name, r), this._updateCountdown(t, r)
                }
            },
            getTimes: function (t) {
            ...
            _determineTime: function (e, t) {
                var n = this,
                    r = this._eqNull(e) ? t : "string" == typeof e ? function (e) {
                        e = e.toLowerCase();
                        for (var t = new Date, r = t.getFullYear(), i = t.getMonth(), a = t.getDate(), s = t.getHours(), o = t.getMinutes(), l = t.getSeconds(), c = /([+-]?[0-9]+)\s*(s|m|h|d|w|o|y)?/g, u = c.exec(e); u;) {
                            switch (u[2] || "s") {
                                case "s":
                                    l += parseInt(u[1], 10);
                                    break;
                                ...
                                case "w":
                                    ...
                                    break;
                                case "o":
                                    i += parseInt(u[1], 10), a = Math.min(a, n._getDaysInMonth(r, i));
                                    break;
                                case "y":
                                    r += parseInt(u[1], 10), a = Math.min(a, n._getDaysInMonth(r, i))
                            }
                            u = c.exec(e)
                        }
                        return new Date(r, i, a, s, o, l, 0)
            ...
            _generateHTML: function (t) {
                ...
                var r = !1,
                    ...
                    s = e.extend({}, t._show),
                    o = null;
                for (o = 0; o <= 6; o++) r = r || "?" === t._show[o] && t._periods[o] > 0, s[o] = "?" !== t._show[o] || r ? t._show[o] : null, i += s[o] ? 1 : 0, a -= t._periods[o] > 0 ? 1 : 0;
                var l = [!1, !1, !1, !1, !1, !1, !1];
                ...
                var c = t.options.compact ? t.options.compactLabels : t.options.labels,
                    ...
                    d = function (e) {
                        var r = t.options["compactLabels" + u(t._periods[e])];
                        return s[e] ? n._translateDigits(t, t._periods[e]) + (r ? r[e] : c[e]) + " " : ""
                    },
                    p = t.options.padZeroes ? 2 : 1,
                    f = function (e) {
                        var r = t.options["labels" + u(t._periods[e])];
                        return !t.options.significant && s[e] || t.options.significant && l[e] ? '<span class="' + n._sectionClass + '"><span class="' + n._amountClass + '">' + n._minDigits(t, t._periods[e], p) + '</span><span class="' + n._periodClass + '">' + (r ? r[e] : c[e]) + "</span></span>" : ""
                    };
            ...
            _buildLayout: function (t, n, r, i, a, s) {
                for (var o = t.options[i ? "compactLabels" : "labels"], l = t.options.whichLabels || this._normalLabels, c = function (e) {
                        return (t.options[(i ? "compactLabels" : "labels") + l(t._periods[e])] || o)[e]
                    }, u = function (e, n) {
            ...
            _calculatePeriods: function (e, t, n, r) {
                e._now = r, e._now.setMilliseconds(0);
                var i = new Date(e._now.getTime());
                e._since ? r.getTime() < e._since.getTime() ? e._now = r = i : r = e._since : (i.setTime(e._until.getTime()), r.getTime() > e._until.getTime() && (e._now = r = i));
                var a = [0, 0, 0, 0, 0, 0, 0];
                if (t[0] || t[1]) {
                    var s = this._getDaysInMonth(r.getFullYear(), r.getMonth()),
                        o = this._getDaysInMonth(i.getFullYear(), i.getMonth()),
                        l = i.getDate() === r.getDate() || i.getDate() >= Math.min(s, o) && r.getDate() >= Math.min(s, o),
                        c = function (e) {
                            return 60 * (60 * e.getHours() + e.getMinutes()) + e.getSeconds()
                        },
                        u = Math.max(0, 12 * (i.getFullYear() - r.getFullYear()) + i.getMonth() - r.getMonth() + (i.getDate() < r.getDate() && !l || l && c(i) < c(r) ? -1 : 0));
                    a[0] = t[0] ? Math.floor(u / 12) : 0, a[1] = t[1] ? u - 12 * a[0] : 0;
                    var d = (r = new Date(r.getTime())).getDate() === s,
                        p = this._getDaysInMonth(r.getFullYear() + a[0], r.getMonth() + a[1]);
                    r.getDate() > p && r.setDate(p), r.setFullYear(r.getFullYear() + a[0]), r.setMonth(r.getMonth() + a[1]), d && r.setDate(p)
                }
                ...
                if (h(2, 604800), h(3, 86400), h(4, 3600), h(5, 60), h(6, 1), f > 0 && !e._since) {
                    var g = [1, 12, 4.3482, 7, 24, 60, 60],
                        y = 6,
                        v = 1;
                    for (m = 6; m >= 0; m--) t[m] && (a[y] >= v && (a[y] = 0, f = 1), f > 0 && (a[m]++, f = 0, y = m, v = 1)), v *= g[m]
                }
                if (n)
    ...
    function (e, t) {
            ...
            for (let n = 1; n < arguments.length; n += 1) {
                ...
                if (null != r && !h(r)) {
                    ...
                    for (let t = 0, i = n.length; t < i; t += 1) {
                        ...
                        void 0 !== a && a.enumerable && (m(e[i]) && m(r[i]) ? r[i].__swiper__ ? e[i] = r[i] : g(e[i], r[i]) : !m(e[i]) && m(r[i]) ? (e[i] = {}, r[i].__swiper__ ? e[i] = r[i] : g(e[i], r[i])) : e[i] = r[i])
                    }
                }
            }
            return e
            ...
            E = {
                ...
                updateSlides: function () {
                    ...
                    for (let i = 0; i < d; i += 1) {
                        S = 0;
                        const s = u.eq(i);
                        if (C && e.grid.updateSlide(i, s, d, t), "none" !== s.css("display")) {
                            if ("auto" === r.slidesPerView) {
                                E && (u[i].style[t("width")] = "");
                                const a = getComputedStyle(s[0]),
                                    o = s[0].style.transform,
                                    l = s[0].style.webkitTransform;
                                if (o && (s[0].style.transform = "none"), l && (s[0].style.webkitTransform = "none"), r.roundLengths) S = e.isHorizontal() ? s.outerWidth(!0) : s.outerHeight(!0);
                                else {
                                    const e = n(a, "width"),
                                        t = n(a, "padding-left"),
                                        r = n(a, "padding-right"),
                                ...
                                o && (s[0].style.transform = o), l && (s[0].style.webkitTransform = l), r.roundLengths && (S = Math.floor(S))
                            } else S = (a - (r.slidesPerView - 1) * w) / r.slidesPerView, r.roundLengths && (S = Math.floor(S)), u[i] && (u[i].style[t("width")] = `${S}px`);
                            u[i] && (u[i].swiperSlideSize = S), m.push(S), r.centeredSlides ? (T = T + S / 2 + x / 2 + w, 0 === x && 0 !== i && (T = T - a / 2 - w), 0 === i && (T = T - a / 2 - w), Math.abs(T) < .001 && (T = 0), r.roundLengths && (T = Math.floor(T)), P % r.slidesPerGroup == 0 && p.push(T), f.push(T)) : (r.roundLengths && (T = Math.floor(T)), (P - Math.min(e.params.slidesPerGroupSkip, P)) % e.params.slidesPerGroup == 0 && p.push(T), f.push(T), T = T + S + w), e.virtualSize += S + w, x = S, P += 1
                        }
                    }
                    if (e.virtualSize = Math.max(e.virtualSize, a) + g, s && o && ("slide" === r.effect || "coverflow" === r.effect) && i.css({
                        ...
                        }), C && e.grid.updateWrapperSize(S, p, t), !r.centeredSlides) {
                        const t = [];
                    ...
                    if (d !== c && e.emit("slidesLengthChange"), p.length !== v && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), f.length !== b && e.emit("slidesGridLengthChange"), r.watchSlidesProgress && e.updateSlidesOffset(), !(l || r.cssMode || "slide" !== r.effect && "fade" !== r.effect)) {
        ...
        var _ = {
                slideTo: function (e, t, n, r, i) {
                    ...
                    if (a.animating && o.preventInteractionOnTransition || !m && !r && !i) return !1;
                ...
                slidePrev: function (e, t, n) {
                    ...
                    let m = 0;
                    if (void 0 !== f && (m = o.indexOf(f), m < 0 && (m = r.activeIndex - 1), "auto" === i.slidesPerView && 1 === i.slidesPerGroup && i.slidesPerGroupAuto && (m = m - r.slidesPerViewDynamic("previous", !0) + 1, m = Math.max(m, 0))), i.rewind && r.isBeginning) {
        ...
        function M(e) {
            ...
            m && d.target && d.target.shadowRoot && h && (f = c(h[0]));
            const g = o.noSwipingSelector ? o.noSwipingSelector : `.${o.noSwipingClass}`,
                y = !(!d.target || !d.target.shadowRoot);
            if (o.noSwiping && (y ? function (e, t) {
            ...
            if (Object.assign(s, {
                    ...
                    isScrolling: void 0,
                    startMoving: void 0
                }), l.startX = v, l.startY = b, s.touchStartTime = p(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, o.threshold > 0 && (s.allowThresholdMove = !1), "touchstart" !== d.type) {
                let e = !0;
        ...
        function A(e) {
            ...
            const d = "touchmove" === u.type && u.targetTouches && (u.targetTouches[0] || u.changedTouches[0]),
                ...
                m = "touchmove" === u.type ? d.pageY : u.pageY;
            ...
            if (i.isTouchEvent && a.touchReleaseOnEdges && !a.loop)
                if (n.isVertical()) {
                    if (m < s.startY && n.translate <= n.maxTranslate() || m > s.startY && n.translate >= n.minTranslate()) return i.isTouched = !1, void(i.isMoved = !1)
            ...
            if (void 0 === i.isScrolling) {
                let e;
                n.isHorizontal() && s.currentY === s.startY || n.isVertical() && s.currentX === s.startX ? i.isScrolling = !1 : h * h + g * g >= 25 && (e = 180 * Math.atan2(Math.abs(g), Math.abs(h)) / Math.PI, i.isScrolling = n.isHorizontal() ? e > a.touchAngle : 90 - e > a.touchAngle)
            }
            ...
            s.diff = y, y *= a.touchRatio, o && (y = -y), n.swipeDirection = y > 0 ? "prev" : "next", i.currentTranslate = y + i.startTranslate;
            let v = !0,
                b = a.resistanceRatio;
            if (a.touchReleaseOnEdges && (b = 0), y > 0 && i.currentTranslate > n.minTranslate() ? (v = !1, a.resistance && (i.currentTranslate = n.minTranslate() - 1 + (-n.minTranslate() + i.startTranslate + y) ** b)) : y < 0 && i.currentTranslate < n.maxTranslate() && (v = !1, a.resistance && (i.currentTranslate = n.maxTranslate() + 1 - (n.maxTranslate() - i.startTranslate - y) ** b)), v && (u.preventedByNestedSwiper = !0), !n.allowSlideNext && "next" === n.swipeDirection && i.currentTranslate < i.startTranslate && (i.currentTranslate = i.startTranslate), !n.allowSlidePrev && "prev" === n.swipeDirection && i.currentTranslate > i.startTranslate && (i.currentTranslate = i.startTranslate), n.allowSlidePrev || n.allowSlideNext || (i.currentTranslate = i.startTranslate), a.threshold > 0) {
                if (!(Math.abs(y) > a.threshold || i.allowThresholdMove)) return void(i.currentTranslate = i.startTranslate);
        ...
        function $(e) {
            ...
            for (let e = 0; e < s.length; e += e < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
                ...
                void 0 !== s[e + t] ? f >= s[e] && f < s[e + t] && (m = e, h = s[e + t] - s[e]) : f >= s[e] && (m = e, h = s[s.length - 1] - s[s.length - 2])
            }
            let g = null,
                y = null;
            ...
            if (u > r.longSwipesMs) {
                ...
                "next" === t.swipeDirection && (v >= r.longSwipesRatio ? t.slideTo(r.rewind && t.isEnd ? g : m + b) : t.slideTo(m)), "prev" === t.swipeDirection && (v > 1 - r.longSwipesRatio ? t.slideTo(m + b) : null !== y && v < 0 && Math.abs(v) > r.longSwipesRatio ? t.slideTo(y) : t.slideTo(m))
            } else {
                if (!r.shortSwipes) return void t.slideTo(t.activeIndex);
                !t.navigation || l.target !== t.navigation.nextEl && l.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(null !== g ? g : m + b), "prev" === t.swipeDirection && t.slideTo(null !== y ? y : m)) : l.target === t.navigation.nextEl ? t.slideTo(m + b) : t.slideTo(m)
            }
        }
        ...
        const B = (e, t) => {
            ...
            (i.preventClicks || i.preventClicksPropagation) && s[d]("click", e.onClick, !0), i.cssMode && o[d]("scroll", e.onScroll), i.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", I, !0) : e[p]("observerUpdate", I, !0)
        };
        var z = {
            attachEvents: function () {
                ...
                e.onTouchStart = M.bind(e), e.onTouchMove = A.bind(e), e.onTouchEnd = $.bind(e), n.cssMode && (e.onScroll = O.bind(e)), e.onClick = D.bind(e), i.touch && !Q && (t.addEventListener("touchstart", L), Q = !0), B(e, "on")
            },
        ...
        const H = {
                ...
                transition: {
                    ...
                    transitionStart: function (e, t) {
                        ...
                        r.cssMode || (r.autoHeight && n.updateAutoHeight(), Y({
                            swiper: n,
                            runCallbacks: e,
                            direction: t,
                            step: "Start"
                    ...
                    transitionEnd: function (e, t) {
                        ...
                        n.animating = !1, r.cssMode || (n.setTransition(0), Y({
                            swiper: n,
                            runCallbacks: e,
                            direction: t,
                            step: "End"
                ...
                breakpoints: {
                    setBreakpoint: function () {
                        ...
                        }), d && !m ? e.disable() : !d && m && e.enable(), e.currentBreakpoint = o, e.emit("_beforeBreakpoint", l), f && n && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - r + e.loopedSlides, 0, !1)), e.emit("breakpoint", l)
                    },
        ...
        class W {
            constructor() {
                ...
                const a = this;
                a.__swiper__ = !0, a.support = x(), a.device = P({
                ...
                const o = g({}, N, s);
                return a.params = g({}, o, V, t), a.originalParams = g({}, a.params), a.passedParams = g({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach((e => {
            ...
            slidesPerViewDynamic(e, t) {
                ...
                if (n.centeredSlides) {
                    ...
                    for (let e = o + 1; e < r.length; e += 1)(t ? i[e] + a[e] - i[o] < s : i[e] - i[o] < s) && (l += 1);
                else
        ...
        const ae = [function (e) {
            ...
            function o(e) {
                ...
                let h, g, y;
                h = n.rtlTranslate ? "right" : n.isHorizontal() ? "left" : "top", i ? (g = Math.floor(t / 2) + r + l, y = Math.floor(t / 2) + r + o) : (g = t + (r - 1) + l, y = r + o);
                const v = Math.max((m || 0) - y, 0),
                    b = Math.min((m || 0) + g, d.length - 1),
                    w = (n.slidesGrid[v] || 0) - (n.slidesGrid[0] || 0);
                ...
                if (Object.assign(n.virtual, {
                    ...
                    }), c === v && u === b && !e) return n.slidesGrid !== p && w !== f && n.slides.css(h, `${w}px`), n.updateProgress(), void a("virtualUpdate");
                ...
                if (e) n.$wrapperEl.find(`.${n.params.slideClass}`).remove();
                    ...
                    for (let e = c; e <= u; e += 1)(e < v || e > b) && n.$wrapperEl.find(`.${n.params.slideClass}[data-swiper-slide-index="${e}"]`).remove();
                for (let t = 0; t < d.length; t += 1) t >= v && t <= b && (void 0 === u || e ? P.push(t) : (t > u && P.push(t), t < c && x.push(t)));
                P.forEach((e => {
            ...
            r({
                ...
                n.params.virtual.enabled && n.params.cssMode && y(n.wrapperEl, "--swiper-virtual-size", `${n.virtualSize}px`)
            ...
            function u(e) {
                ...
                if (!(r.shiftKey || r.altKey || r.ctrlKey || r.metaKey || o.activeElement && o.activeElement.nodeName && ("input" === o.activeElement.nodeName.toLowerCase() || "textarea" === o.activeElement.nodeName.toLowerCase()))) {
                    ...
                    t.isHorizontal() ? ((c || u || d || p) && (r.preventDefault ? r.preventDefault() : r.returnValue = !1), ((u || p) && !n || (c || d) && n) && t.slideNext(), ((c || d) && !n || (u || p) && n) && t.slidePrev()) : ((c || u || f || m) && (r.preventDefault ? r.preventDefault() : r.returnValue = !1), (u || m) && t.slideNext(), (c || f) && t.slidePrev()), s("keyPress", i)
                }
            }
            ...
            function y(e) {
                ...
                else u = Math.abs(h.pixelX) > Math.abs(h.pixelY) ? -h.pixelX * m : -h.pixelY;
                if (0 === u) return !0;
                a.invert && (u = -u);
                let y = t.getTranslate() + u * a.sensitivity;
                if (y >= t.minTranslate() && (y = t.minTranslate()), y <= t.maxTranslate() && (y = t.maxTranslate()), r = !!t.params.loop || !(y === t.minTranslate() || y === t.maxTranslate()), r && t.params.nested && n.stopPropagation(), t.params.freeMode && t.params.freeMode.enabled) {
                    const e = {
                            time: p(),
                            delta: Math.abs(u),
            ...
            function v(e) {
                let n = t.$el;
                "container" !== t.params.mousewheel.eventsTarget && (n = c(t.params.mousewheel.eventsTarget)), n[e]("mouseenter", m), n[e]("mouseleave", h), n[e]("wheel", y)
            }
            ...
            function d() {
                ...
                if ("fraction" === n.type && (a.find(X(n.currentClass)).text(n.formatFractionCurrent(d + 1)), a.find(X(n.totalClass)).text(n.formatFractionTotal(p))), "progressbar" === n.type) {
                    let e;
                    e = n.progressbarOpposite ? t.isHorizontal() ? "vertical" : "horizontal" : t.isHorizontal() ? "horizontal" : "vertical";
                    const r = (d + 1) / p;
                    let i = 1,
                        s = 1;
                    "horizontal" === e ? i = r : s = r, a.find(X(n.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${i}) scaleY(${s})`).transition(t.params.speed)
                }
            ...
            function g() {
                ...
                let o = l,
                    c = (u - l) * r;
                n ? (c = -c, c > 0 ? (o = l - c, c = 0) : -c + l > u && (o = u + c)) : c < 0 ? (o = l + c, c = 0) : c + l > u && (o = u - c), t.isHorizontal() ? (i.transform(`translate3d(${c}px, 0, 0)`), i[0].style.width = `${o}px`) : (i.transform(`translate3d(0px, ${c}px, 0)`), i[0].style.height = `${o}px`), s.hide && (clearTimeout(m), a[0].style.opacity = 1, m = setTimeout((() => {
            ...
            function b(e) {
                ...
                let a;
                a = (v(e) - i.offset()[t.isHorizontal() ? "left" : "top"] - (null !== o ? o : l / 2)) / (u - l), a = Math.max(Math.min(a, 1), 0), r && (a = 1 - a);
            ...
            function w(e) {
                ...
                f = !0, o = e.target === l[0] || e.target === l ? v(e) - e.target.getBoundingClientRect()[t.isHorizontal() ? "left" : "top"] : null, e.preventDefault(), e.stopPropagation(), i.transition(100), l.transition(100), b(e), clearTimeout(h), s.transition(0), n.hide && s.css("opacity", 1), t.params.cssMode && t.$wrapperEl.css("scroll-snap-type", "none"), a("scrollbarDragStart", e)
            }
            ...
            function x(e) {
                ...
                f && (f = !1, t.params.cssMode && (t.$wrapperEl.css("scroll-snap-type", ""), i.transition("")), n.hide && (clearTimeout(h), h = d((() => {
            ...
            function P(e) {
                ...
                o.touch ? (c[p](r.start, w, u), c[p](r.move, T, u), c[p](r.end, x, d)) : (c[p](i.start, w, u), s[p](i.move, T, u), s[p](i.end, x, d))
            }
            ...
            function C() {
                ...
                0 === a.length && (a = c(`<div class="${t.params.scrollbar.dragClass}"></div>`), i.append(a)), Object.assign(e, {
                    ...
                    $dragEl: a,
                    dragEl: a[0]
                }), r.draggable && t.params.scrollbar.el && t.scrollbar.el && P("on"), i && i[t.enabled ? "removeClass" : "addClass"](t.params.scrollbar.lockClass)
            }

            function S() {
                const e = t.params.scrollbar,
                    n = t.scrollbar.$el;
                n && n.removeClass(t.isHorizontal() ? e.horizontalClass : e.verticalClass), t.params.scrollbar.el && t.scrollbar.el && P("off")
            }
            n({
                scrollbar: {
                    el: null,
                ...
                !1 === t.params.scrollbar.enabled ? E() : (C(), y(), g())
            ...
            Object.assign(t.scrollbar, {
                enable: () => {
                    t.$el.removeClass(t.params.scrollbar.scrollbarDisabledClass), t.scrollbar.$el && t.scrollbar.$el.removeClass(t.params.scrollbar.scrollbarDisabledClass), C(), y(), g()
                },
                disable: E,
                updateSize: y,
                setTranslate: g,
            ...
            const i = (e, n) => {
                    const {
                        rtl: r
                    } = t, i = c(e), a = r ? -1 : 1, s = i.attr("data-swiper-parallax") || "0";
            ...
            function w(e) {
                ...
                m.$imageEl && 0 !== m.$imageEl.length ? (n.gestures ? i.scale = e.scale * d : i.scale = m.scaleMove / m.scaleStart * d, i.scale > m.maxRatio && (i.scale = m.maxRatio - 1 + (i.scale - m.maxRatio + 1) ** .5), i.scale < r.minRatio && (i.scale = r.minRatio + 1 - (r.minRatio - i.scale + 1) ** .5), m.$imageEl.transform(`translate3d(0,0,0) scale(${i.scale})`)) : "gesturechange" === e.type && b(e)
            }
            ...
            function T(e) {
                ...
                m.$imageEl && 0 !== m.$imageEl.length && (a.scale = Math.max(Math.min(a.scale, m.maxRatio), i.minRatio), m.$imageEl.transition(t.params.speed).transform(`translate3d(0,0,0) scale(${a.scale})`), d = a.scale, p = !1, 1 === a.scale && (m.$slideEl = void 0))
            }
            ...
            function x(e) {
                ...
                const r = h.width * n.scale,
                    i = h.height * n.scale;
                if (!(r < m.slideWidth && i < m.slideHeight)) {
                    if (h.minX = Math.min(m.slideWidth / 2 - r / 2, 0), h.maxX = -h.minX, h.minY = Math.min(m.slideHeight / 2 - i / 2, 0), h.maxY = -h.minY, h.touchesCurrent.x = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, h.touchesCurrent.y = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, !h.isMoved && !p) {
            ...
            function P() {
                const e = t.zoom;
                m.$slideEl && t.previousIndex !== t.activeIndex && (m.$imageEl && m.$imageEl.transform("translate3d(0,0,0) scale(1)"), m.$imageWrapEl && m.$imageWrapEl.transform("translate3d(0,0,0)"), e.scale = 1, d = 1, m.$slideEl = void 0, m.$imageEl = void 0, m.$imageWrapEl = void 0)
            }

            function C(e) {
                const n = t.zoom,
                    r = t.params.zoom;
                if (m.$slideEl || (e && e.target && (m.$slideEl = c(e.target).closest(`.${t.params.slideClass}`)), m.$slideEl || (t.params.virtual && t.params.virtual.enabled && t.virtual ? m.$slideEl = t.$wrapperEl.children(`.${t.params.slideActiveClass}`) : m.$slideEl = t.slides.eq(t.activeIndex)), m.$imageEl = m.$slideEl.find(`.${r.containerClass}`).eq(0).find("picture, img, svg, canvas, .swiper-zoom-target").eq(0), m.$imageWrapEl = m.$imageEl.parent(`.${r.containerClass}`)), !m.$imageEl || 0 === m.$imageEl.length || !m.$imageWrapEl || 0 === m.$imageWrapEl.length) return;
                let i, a, o, l, u, p, f, g, y, v, b, w, T, x, P, C, S, E;
                t.params.cssMode && (t.wrapperEl.style.overflow = "hidden", t.wrapperEl.style.touchAction = "none"), m.$slideEl.addClass(`${r.zoomedSlideClass}`), void 0 === h.touchesStart.x && e ? (i = "touchend" === e.type ? e.changedTouches[0].pageX : e.pageX, a = "touchend" === e.type ? e.changedTouches[0].pageY : e.pageY) : (i = h.touchesStart.x, a = h.touchesStart.y), n.scale = m.$imageWrapEl.attr("data-swiper-zoom") || r.maxRatio, d = m.$imageWrapEl.attr("data-swiper-zoom") || r.maxRatio, e ? (S = m.$slideEl[0].offsetWidth, E = m.$slideEl[0].offsetHeight, o = m.$slideEl.offset().left + s.scrollX, l = m.$slideEl.offset().top + s.scrollY, u = o + S / 2 - i, p = l + E / 2 - a, y = m.$imageEl[0].offsetWidth, v = m.$imageEl[0].offsetHeight, b = y * n.scale, w = v * n.scale, T = Math.min(S / 2 - b / 2, 0), x = Math.min(E / 2 - w / 2, 0), P = -T, C = -x, f = u * n.scale, g = p * n.scale, f < T && (f = T), f > P && (f = P), g < x && (g = x), g > C && (g = C)) : (f = 0, g = 0), m.$imageWrapEl.transition(300).transform(`translate3d(${f}px, ${g}px,0)`), m.$imageEl.transition(300).transform(`translate3d(0,0,0) scale(${n.scale})`)
            }
            ...
            function _(e) {
                ...
                t.$wrapperEl[e]("gesturestart", r, b, n), t.$wrapperEl[e]("gesturechange", r, w, n), t.$wrapperEl[e]("gestureend", r, T, n)
            }
            ...
            function A() {
                ...
                const n = t.support,
                    ...
                    a = Y();
                n.gestures ? (t.$wrapperEl.on(t.touchEvents.start, j, r), t.$wrapperEl.on(t.touchEvents.end, M, r)) : "touchstart" === t.touchEvents.start && (t.$wrapperEl.on(t.touchEvents.start, a, b, r), t.$wrapperEl.on(t.touchEvents.move, a, w, i), t.$wrapperEl.on(t.touchEvents.end, a, T, r), t.touchEvents.cancel && t.$wrapperEl.on(t.touchEvents.cancel, a, T, r)), t.$wrapperEl.on(t.touchEvents.move, `.${t.params.zoom.containerClass}`, x, i)
            }
            ...
            function $() {
                ...
                n.gestures ? (t.$wrapperEl.off(t.touchEvents.start, j, r), t.$wrapperEl.off(t.touchEvents.end, M, r)) : "touchstart" === t.touchEvents.start && (t.$wrapperEl.off(t.touchEvents.start, a, b, r), t.$wrapperEl.off(t.touchEvents.move, a, w, i), t.$wrapperEl.off(t.touchEvents.end, a, T, r), t.touchEvents.cancel && t.$wrapperEl.off(t.touchEvents.cancel, a, T, r)), t.$wrapperEl.off(t.touchEvents.move, `.${t.params.zoom.containerClass}`, x, i)
            }
            Object.defineProperty(t.zoom, "scale", {
                ...
                t.zoom.enabled && function () {
                    ...
                    const i = g.x * n,
                        ...
                        s = g.y * r,
                        o = h.currentY + s;
                    0 !== g.x && (n = Math.abs((a - h.currentX) / g.x)), 0 !== g.y && (r = Math.abs((o - h.currentY) / g.y));
                    const l = Math.max(n, r);
                    h.currentX = a, h.currentY = o;
                    const c = h.width * e.scale,
                        u = h.height * e.scale;
                    h.minX = Math.min(m.slideWidth / 2 - c / 2, 0), h.maxX = -h.minX, h.minY = Math.min(m.slideHeight / 2 - u / 2, 0), h.maxY = -h.minY, h.currentX = Math.max(Math.min(h.currentX, h.maxX), h.minX), h.currentY = Math.max(Math.min(h.currentY, h.maxY), h.minY), m.$imageWrapEl.transition(l).transform(`translate3d(${h.currentX}px, ${h.currentY}px,0)`)
                }()
            })), r("doubleTap", ((e, n) => {
            ...
            function u() {
                const {
                    ...
                    slides: r,
                    activeIndex: i
                } = t, a = t.virtual && n.virtual.enabled, s = n.lazy;
            ...
            function d() {
                ...
                f ? (u(), n.off("scroll", d, h)) : s || (s = !0, n.on("scroll", d, h))
            }
            r("beforeInit", (() => {
            ...
            const y = (e, t, n) => {
                    s(e), "BUTTON" !== e[0].tagName && (l(e, "button"), e.on("keydown", m)), d(e, n),
                        function (e, t) {
            ...
            r("beforeInit", (() => {
                ...
                t.params.a11y.enabled && (() => {
                    ...
                    const r = t.$wrapperEl,
                        a = e.id || r.attr("id") || `swiper-wrapper-${s=16,void 0===s&&(s=16),"x".repeat(s).replace(/x/g,(()=>Math.round(16*Math.random()).toString(16)))}`;
                    var s;
                    ...
                    l = a, r.attr("id", l),
                        function (e, t) {
                            e.attr("aria-live", t)
                        }(r, o), T(), t.navigation && t.navigation.$nextEl && (c = t.navigation.$nextEl), t.navigation && t.navigation.$prevEl && (p = t.navigation.$prevEl), c && c.length && y(c, a, e.nextSlideMessage), p && p.length && y(p, a, e.prevSlideMessage), g() && t.pagination.$el.on("keydown", X(t.params.pagination.bulletClass), m), t.$el.on("focus", w, !0), t.$el.on("pointerdown", v, !0), t.$el.on("pointerup", b, !0)
                })()
                ...
                t.params.a11y.enabled && function () {
                    let e, n;
                    i && i.length > 0 && i.remove(), t.navigation && t.navigation.$nextEl && (e = t.navigation.$nextEl), t.navigation && t.navigation.$prevEl && (n = t.navigation.$prevEl), e && e.off("keydown", m), n && n.off("keydown", m), g() && t.pagination.$el.off("keydown", X(t.params.pagination.bulletClass), m), t.$el.off("focus", w, !0), t.$el.off("pointerdown", v, !0), t.$el.off("pointerup", b, !0)
                }()
            }))
        }, function (e) {
            let {
            ...
            const d = () => {
                ...
                p = () => {
                    if (o && t.params.hashNavigation.enabled)
                        if (t.params.hashNavigation.replaceState && u.history && u.history.replaceState) u.history.replaceState(null, null, `#${t.slides.eq(t.activeIndex).attr("data-hash")}` || ""), i("hashSet");
                        else {
            ...
            n.autoplay = {
                ...
                n.params.autoplay.enabled && (l(), r().addEventListener("visibilitychange", p), n.params.autoplay.pauseOnMouseEnter && (n.$el.on("mouseenter", m), n.$el.on("mouseleave", h)))
                ...
                n.$el.off("mouseenter", m), n.$el.off("mouseleave", h), n.autoplay.running && c(), r().removeEventListener("visibilitychange", p)
                    ...
                    onTouchEnd: function (e) {
                        ...
                        if (n < -t.minTranslate()) t.slideTo(t.activeIndex);
                            ...
                            if (a.freeMode.momentum) {
                                ...
                                let h;
                                if (u < t.maxTranslate()) a.freeMode.momentumBounce ? (u + t.maxTranslate() < -m && (u = t.maxTranslate() - m), d = t.maxTranslate(), f = !0, c.allowMomentumBounce = !0) : u = t.maxTranslate(), a.loop && a.centeredSlides && (h = !0);
                                else if (u > t.minTranslate()) a.freeMode.momentumBounce ? (u - t.minTranslate() > m && (u = t.minTranslate() + m), d = t.minTranslate(), f = !0, c.allowMomentumBounce = !0) : u = t.minTranslate(), a.loop && a.centeredSlides && (h = !0);
            ...
            a({
                ...
                updateSlide: (e, a, s, o) => {
                    ...
                    if ("row" === d && l > 1) {
                        ...
                        m = Math.floor(r / i), f = r - m * i + n * l, p = f + m * t / u, a.css({
                            "-webkit-order": p,
                            order: p
                        })
                    } else "column" === d ? (f = Math.floor(e / u), m = e - f * u, (f > r || f === r && m === u - 1) && (m += 1, m >= u && (m = 0, f += 1))) : (m = Math.floor(e / n), f = e - m * n);
            ...
            te({
                ...
                setTranslate: () => {
                    const {
                        ...
                        size: l,
                        browser: u
                    } = t, d = t.params.cubeEffect, p = t.isHorizontal(), f = t.virtual && t.params.virtual.enabled;
                    let m, h = 0;
                    d.shadow && (p ? (m = n.find(".swiper-cube-shadow"), 0 === m.length && (m = c('<div class="swiper-cube-shadow"></div>'), n.append(m)), m.css({
                        height: `${a}px`
                    ...
                    for (let e = 0; e < r.length; e += 1) {
                        ...
                        let u = 0,
                            m = 0,
                            g = 0;
                        n % 4 == 0 ? (u = 4 * -s * l, g = 0) : (n - 1) % 4 == 0 ? (u = 0, g = 4 * -s * l) : (n - 2) % 4 == 0 ? (u = l + 4 * s * l, g = l) : (n - 3) % 4 == 0 && (u = -l, g = 3 * l + 4 * l * s), o && (u = -u), p || (m = u, u = 0);
                        const y = `rotateX(${p?0:-a}deg) rotateY(${p?a:0}deg) translate3d(${u}px, ${m}px, ${g}px)`;
                        c <= 1 && c > -1 && (h = 90 * n + 90 * c, o && (h = 90 * -n - 90 * c)), t.transform(y), d.slideShadows && i(t, c, p)
                    }
                    if (n.css({
                            "-webkit-transform-origin": `50% 50% -${l/2}px`,
                            "transform-origin": `50% 50% -${l/2}px`
                        }), d.shadow)
                        if (p) m.transform(`translate3d(0px, ${a/2+d.shadowOffset}px, ${-a/2}px) rotateX(90deg) rotateZ(0deg) scale(${d.shadowScale})`);
                        else {
                            const e = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90),
                                ...
                                r = d.shadowScale / t,
                                i = d.shadowOffset;
                            m.transform(`scale3d(${n}, 1, ${r}) translate3d(0px, ${s/2+i}px, ${-s/2/r}px) rotateX(-90deg)`)
            ...
            n({
                ...
                setTranslate: () => {
                    ...
                    for (let e = 0, t = r.length; e < t; e += 1) {
                        ...
                        let g = s ? 0 : h * d,
                            y = s ? h * d : 0,
                            v = 1 - (1 - a.scale) * Math.abs(d);
                        Math.abs(y) < .001 && (y = 0), Math.abs(g) < .001 && (g = 0), Math.abs(m) < .001 && (m = 0), Math.abs(p) < .001 && (p = 0), Math.abs(f) < .001 && (f = 0), Math.abs(v) < .001 && (v = 0);
                        const b = `translate3d(${y}px,${g}px,${m}px)  rotateX(${f}deg) rotateY(${p}deg) scale(${v})`;
                        if (ne(a, t).transform(b), t[0].style.zIndex = 1 - Math.abs(Math.round(d)), a.slideShadows) {
                            ...
                            0 === e.length && (e = ie(a, t, s ? "left" : "top")), 0 === n.length && (n = ie(a, t, s ? "right" : "bottom")), e.length && (e[0].style.opacity = d > 0 ? d : 0), n.length && (n[0].style.opacity = -d > 0 ? -d : 0)
                        }
                    }
                },
                setTransition: e => {
                ...
                setTranslate: () => {
                    ...
                    for (let n = 0; n < e.length; n += 1) {
                        ...
                        c < 0 ? (h = a.next, m = !0) : c > 0 && (h = a.prev, m = !0), p.forEach(((e, t) => {
                            p[t] = `calc(${e}px + (${i(h.translate[t])} * ${Math.abs(c*s)}))`
                        })), f.forEach(((e, t) => {
                            f[t] = h.rotate[t] * Math.abs(c * s)
                        })), r[0].style.zIndex = -Math.abs(Math.round(l)) + e.length;
                        const g = p.join(", "),
                            y = `rotateX(${f[0]}deg) rotateY(${f[1]}deg) rotateZ(${f[2]}deg)`,
                            v = u < 0 ? `scale(${1+(1-h.scale)*u*s})` : `scale(${1-(1-h.scale)*u*s})`,
                            b = u < 0 ? 1 + (1 - h.opacity) * u * s : 1 - (1 - h.opacity) * u * s,
                            w = `translate3d(${g}) ${y} ${v}`;
                        if (m && h.shadow || !m) {
                            let e = r.children(".swiper-slide-shadow");
                            if (0 === e.length && h.shadow && (e = ie(a, r)), e.length) {
                        ...
                        T.transform(w).css({
                            opacity: b
                        }), h.origin && T.css("transform-origin", h.origin)
                    }
                },
                setTransition: e => {
                    const {
                ...
                setTranslate: () => {
                    ...
                    for (let o = 0; o < e.length; o += 1) {
                        ...
                        const v = t.virtual && t.params.virtual.enabled ? t.virtual.from + o : o,
                            b = (v === n || v === n - 1) && u > 0 && u < 1 && (a || t.params.cssMode) && s < i,
                            w = (v === n || v === n + 1) && u < 0 && u > -1 && (a || t.params.cssMode) && s > i;
                        if (b || w) {
                            const e = (1 - Math.abs((Math.abs(u) - .5) / .5)) ** .5;
                            g += -28 * u * e, h += -.5 * e, y += 96 * e, f = -25 * e * Math.abs(u) + "%"
                        }
                        if (p = u < 0 ? `calc(${p}px + (${y*Math.abs(u)}%))` : u > 0 ? `calc(${p}px + (-${y*Math.abs(u)}%))` : `${p}px`, !t.isHorizontal()) {
                            const e = f;
                            f = p, p = e
                        }
                        const T = u < 0 ? "" + (1 + (1 - h) * u) : "" + (1 - (1 - h) * u),
                            x = `\n        translate3d(${p}, ${f}, ${m}px)\n        rotateZ(${r.rotate?g:0}deg)\n        scale(${T})\n      `;
                        if (r.slideShadows) {
                            let e = l.find(".swiper-slide-shadow");
                            0 === e.length && (e = ie(r, l)), e.length && (e[0].style.opacity = Math.min(Math.max((Math.abs(u) - .5) / .5, 0), 1))
                        }
                        l[0].style.zIndex = -Math.abs(Math.round(c)) + e.length, ne(r, l).transform(x)
                    }
                },
                setTransition: e => {
                    const {
    ...
    function (e) {
        e.fn.skillBars = function (t) {
            ...
            return this.each((function () {
                var t = e(this),
                    r = 0 != n.to ? n.to : parseInt(t.attr("data-percent"));
                r > 100 && (r = 100);
                var i = n.from,
                    ...
                    l = setInterval((function () {
                        i += s, o++, e(t).find(n.classes.skillBarPercent).text(i.toFixed(n.decimals) + "%"), "function" == typeof n.onUpdate && n.onUpdate.call(t, i), o >= a && (clearInterval(l), i = r, "function" == typeof n.onComplete && n.onComplete.call(t, i))
                    }), n.interval);
    ...
    function (e) {
        ...
        var t = {
            ...
            n = {},
            r = function (n, r) {
                this.elmt = n, this.settings = e.extend({}, t, e.vegas.defaults, r), this.slide = this.settings.slide, this.total = this.settings.slides.length, this.noshow = this.total < 2, this.paused = !this.settings.autoplay || this.noshow, this.ended = !1, this.$elmt = e(n), this.$timer = null, this.$overlay = null, this.$slide = null, this.timeout = null, this.first = !0, this.transitions = ["fade", "fade2", "blur", "blur2", "flash", "flash2", "negative", "negative2", "burn", "burn2", "slideLeft", "slideLeft2", "slideRight", "slideRight2", "slideUp", "slideUp2", "slideDown", "slideDown2", "zoomIn", "zoomIn2", "zoomOut", "zoomOut2", "swirlLeft", "swirlLeft2", "swirlRight", "swirlRight2"], this.animations = ["kenburns", "kenburnsLeft", "kenburnsRight", "kenburnsUp", "kenburnsUpLeft", "kenburnsUpRight", "kenburnsDown", "kenburnsDownLeft", "kenburnsDownRight"], this.settings.transitionRegister instanceof Array || (this.settings.transitionRegister = [this.settings.transitionRegister]), this.settings.animationRegister instanceof Array || (this.settings.animationRegister = [this.settings.animationRegister]), this.transitions = this.transitions.concat(this.settings.transitionRegister), this.animations = this.animations.concat(this.settings.animationRegister), this.support = {
        ...
        r.prototype = {
            _init: function () {
                var t, n, r, i, a = "BODY" === this.elmt.tagName,
            ...
            _video: function (e) {
                var t, r, i = e.toString();
                return n[i] ? n[i] : (e instanceof Array || (e = [e]), (t = document.createElement("video")).preload = !0, e.forEach((function (e) {
                    (r = document.createElement("source")).src = e, t.appendChild(r)
                })), n[i] = t, t)
            },
            _fadeOutSound: function (e, t) {
                var n = this,
                    r = t / 10,
                    i = e.volume - .09;
                i > 0 ? (e.volume = i, setTimeout((function () {
                    n._fadeOutSound(e, t)
                }), r)) : e.pause()
            },
            _fadeInSound: function (e, t) {
                var n = this,
                    r = t / 10,
                    i = e.volume + .09;
                i < 1 && (e.volume = i, setTimeout((function () {
                    n._fadeInSound(e, t)
                }), r))
            },
            ...
            _goto: function (t) {
                ...
                var n, r, i, a, s, o = this.$elmt.children(".vegas-slide"),
                ...
                function T() {
                    h._timer(!0), setTimeout((function () {
                        y && (h.support.transition ? (o.css("transition", "all " + v + "ms").addClass("vegas-transition-" + y + "-out"), o.each((function () {
                            var e = o.find("video").get(0);
                            e && (e.volume = 1, h._fadeOutSound(e, v))
                        })), n.css("transition", "all " + v + "ms").addClass("vegas-transition-" + y + "-in")) : n.fadeIn(v));
                ...
                })), h._timer(!1), a ? (4 === a.readyState && (a.currentTime = 0), a.play(), T()) : (s.src = l, s.complete ? T() : s.onload = T)
            },
            _end: function () {
            ...
            options: function (n, r) {
                ...
                if ("object" == typeof n) this.settings = e.extend({}, t, e.vegas.defaults, n);
                    ...
                    if (void 0 === r) return this.settings[n];
                    this.settings[n] = r
                }
            ...
            if (void 0 === e || "object" == typeof e) return this.each((function () {
                this._vegas || (this._vegas = new r(this, e))
            }));
            if ("string" == typeof e) {
                if (this.each((function () {
                        var r = this._vegas;
                        if (!r) throw new Error("No Vegas applied to this element.");
                        "function" == typeof r[e] && "_" !== e[0] ? t = r[e].apply(r, [].slice.call(n, 1)) : i = !0
                    })), i) throw new Error('No method "' + e + '" in Vegas.');
                return void 0 !== t ? t : this
            }
...
let getYTPVideoID = function (e) {
    let t, n;
    return e.indexOf("youtu.be") > 0 || e.indexOf("youtube.com/embed") > 0 ? t = (n = (t = e.substr(e.lastIndexOf("/") + 1, e.length)).indexOf("?list=") > 0 ? t.substr(t.lastIndexOf("="), t.length) : null) ? t.substr(0, t.lastIndexOf("?")) : t : e.indexOf("http") > -1 ? (t = e.match(/[\\?&]v=([^&#]*)/)[1], n = e.indexOf("list=") > 0 ? e.match(/[\\?&]list=([^&#]*)/)[1] : null) : n = (t = e.length > 15 ? null : e) ? null : e, {
        videoID: t,
        playlistID: n
    }
};
    ...
    jQuery.mbYTPlayer = {
        ...
        buildPlayer: function (options) {
            ...
            return this.each((function () {
                ...
                jQuery.mbBrowser.mobile && YTPlayer.opt.autoPlay && YTPlayer.opt.useOnMobile && jQuery("body").one("touchstart", (function () {
                    ...
                    let e = this,
                        t = jQuery(e);
                    e.isBackground && ytp.backgroundIsInited || e.isInit || (e.isBackground && (ytp.backgroundIsInited = !0), e.opt.autoPlay = void 0 === e.opt.autoPlay ? !!e.isBackground : e.opt.autoPlay, e.opt.vol = e.opt.vol ? e.opt.vol : 100, jQuery.mbYTPlayer.getDataFromAPI(e), jQuery(e).on("YTPChanged", (function (n) {
                        if (e.isInit) return;
                        e.isInit = !0;
                        let r = {
                            modestbranding: 1,
                        ...
                        new YT.Player(e.playerID, {
                            ...
                            events: {
                                onReady: function (n) {
                                    e.player = n.target, e.player.loadVideoById({
                                ...
                                onStateChange: function (t) {
                                    ...
                                    let n, r = t.target.getPlayerState();
                                    if (e.preventTrigger || e.isStarting) return void(e.preventTrigger = !1);
                                    switch (e.state = r, t.data === YT.PlayerState.PLAYING && t.target.setPlaybackQuality(e.opt.quality), r) {
                                        case -1:
                                            n = "YTPUnstarted";
                                            break;
                                        case 0:
                                    ...
                                    let i = jQuery.Event(n);
                                    i.time = e.currentTime, jQuery(e).trigger(i)
                                },
                                onPlaybackQualityChange: function (t) {
                                    let n = t.target.getPlaybackQuality(),
                                        r = jQuery.Event("YTPQualityChange");
                                    r.quality = n, jQuery(e).trigger(r)
                                },
                                onError: function (n) {
                                    switch ("function" == typeof e.opt.onError && e.opt.onError(t, n), console.debug("error:", n), n.data) {
                                        case 2:
        ...
        isOnScreen: function (e, t) {
            ...
            let n = e.wrapper,
                ...
                a = n.height() * t / 100,
                s = n.offset().top + a;
            return n.offset().top + (n.height() - a) <= i && s >= r
        },
        getDataFromAPI: function (e) {
            e.videoData = jQuery.mbStorage.get("YTPlayer_data_" + e.videoID), e.videoData ? (setTimeout((function () {
                ...
                n.prop = {};
                for (let t in e.videoData) e.videoData.hasOwnProperty(t) && (n.prop[t] = e.videoData[t]);
                jQuery(e).trigger(n)
                ...
                e.dataReceived = !0;
                let n = jQuery.Event("YTPChanged");
                n.time = e.currentTime, n.videoId = e.videoID, jQuery(e).trigger(n), t.items[0] ? (function (t) {
                ...
                r.prop = {};
                for (let t in e.videoData) r.prop[t] = e.videoData[t];
                jQuery(e).trigger(r)
            })).fail((function (t) {
                console.error("YT data error:: ", t), e.hasData = !1;
                let n = jQuery.Event("YTPChanged");
                n.time = e.currentTime, n.videoId = e.videoID, jQuery(e).trigger(n)
            })) : (setTimeout((function () {
                let t = jQuery.Event("YTPChanged");
        ...
        setVideoQuality: function (e) {
            let t = this.get(0),
                n = t.player.getCurrentTime();
            return jQuery(t).YTPPause(), t.opt.quality = e, t.player.setPlaybackQuality(e), t.player.seekTo(n), jQuery(t).YTPPlay(), this
        },
        ...
        playlist: function (e, t, n) {
            let r = this.get(0);
            return r.isList = !0, t && (e = jQuery.shuffle(e)), r.videoID || (r.videos = e, r.videoCounter = 1, r.videoLength = e.length, jQuery(r).data("property", e[0]), jQuery(r).YTPlayer()), "function" == typeof n && jQuery(r).on("YTPChanged", (function () {
                n(r)
        ...
        playIndex: function (e) {
            ...
            let n = t.videos[t.videoCounter - 1];
            return jQuery(t).YTPChangeVideo(n), this
        },
        changeVideo: function (e) {
            ...
            n.opt.startAt = 0, n.opt.stopAt = 0, n.opt.mask = !1, n.opt.mute = !0, n.opt.autoPlay = !0, n.opt.addFilters = !1, n.opt.coverImage = !1, n.hasData = !1, n.hasChanged = !0, n.player.loopTime = void 0, e && jQuery.extend(n.opt, e), n.videoID = getYTPVideoID(n.opt.videoURL).videoID, n.opt.loop && "boolean" == typeof n.opt.loop && (n.opt.loop = 9999), n.wrapper.css({
                ...
                jQuery.mbYTPlayer.getDataFromAPI(n), t.YTPGetPlayer().loadVideoById({
                    videoId: n.videoID,
                    suggestedQuality: n.opt.quality
                }), t.YTPPause(), t.optimizeDisplay(), n.checkForStartAt && (clearInterval(n.checkForStartAt), clearInterval(n.getState)), t.YTPCheckForState()
            }));
            let r = jQuery.Event("YTPChangeVideo");
            return r.time = n.currentTime, jQuery(n).trigger(r), jQuery.mbYTPlayer.applyMask(n), this
        },
        getPlayer: function () {
            let e = this.get(0);
        ...
        fullscreen: function (real) {
            ...
            function RunPrefixMethod(e, t) {
                let n, r, i = ["webkit", "moz", "ms", "o", ""],
                    a = 0;
                for (; a < i.length && !e[n];) {
                    if (n = t, "" === i[a] && (n = n.substr(0, 1).toLowerCase() + n.substr(1)), "undefined" != (r = typeof e[n = i[a] + n])) return i = [i[a]], "function" == r ? e[n]() : e[n];
                    a++
                }
            }
        ...
        applyFilter: function (e, t) {
            ...
            n.filters[e].value = t, n.filtersEnabled && this.YTPEnableFilters()
        },
        applyFilters: function (e) {
            let t = this,
                n = t.get(0);
            if (!n.isReady) return jQuery(n).on("YTPReady", (function () {
                t.YTPApplyFilters(e)
            })), this;
            for (let n in e) t.YTPApplyFilter(n, e[n]);
            t.trigger("YTPFiltersApplied")
        },
        toggleFilter: function (e, t) {
            let n = this.get(0);
            return n.isReady ? (n.filters[e].value ? n.filters[e].value = 0 : n.filters[e].value = t, n.filtersEnabled && jQuery(n).YTPEnableFilters(), this) : this
        },
        ...
        enableFilters: function () {
            ...
            let t = jQuery(e.playerEl),
                n = "";
            for (let t in e.filters) e.filters[t].value && (n += t.replace("_", "-") + "(" + e.filters[t].value + e.filters[t].unit + ") ");
        ...
        removeFilter: function (e, t) {
            ...
            if ("function" == typeof e && (t = e, e = null), e) n.YTPApplyFilter(e, 0), "function" == typeof t && t(e);
            else {
                for (let e in r.filters) r.filters.hasOwnProperty(e) && (n.YTPApplyFilter(e, 0), "function" == typeof t && t(e));
                r.filters = jQuery.extend(!0, {}, jQuery.mbYTPlayer.defaultFilters)
            }
            let i = jQuery.Event("YTPFiltersApplied");
            return n.trigger(i), this
        },
        getFilters: function () {
            let e = this.get(0);
        ...
        addMask: function (e) {
            let t = this.get(0);
            e || (e = t.actualMask);
            let n = jQuery("<img/>").attr("src", e).on("load", (function () {
                t.overlay.CSSAnimate({
                    opacity: 0
                }, t.opt.fadeOnStartTime, (function () {
                    t.hasMask = !0, n.remove(), t.overlay.css({
        ...
        applyMask: function (e) {
            ...
            if (t.off("YTPTime.mask"), e.opt.mask)
                ...
                e.opt.mask[0] && t.YTPAddMask(e.opt.mask[0]), t.on("YTPTime.mask", (function (n) {
                    for (let r in e.opt.mask) n.time === r && (e.opt.mask[r] ? (t.YTPAddMask(e.opt.mask[r]), e.actualMask = e.opt.mask[r]) : t.YTPRemoveMask())
                }))
            }
        },
        toggleMask: function () {
        ...
        changeCoverImage: function (e) {
            ...
            if (t.opt.coverImage || t.orig_containment_background) {
                let n = e || (t.opt.coverImage ? "url(" + t.opt.coverImage + ") center center" : t.orig_containment_background);
                n && t.opt.containment.css({
                    background: n,
                    backgroundSize: "cover",
                    backgroundRepeat: "no-repeat",
        ...
        setAbundance: function (e, t) {
            let n = this.get(0);
            return t && (n.opt.abundance = e), this.optimizeDisplay(n.opt.anchor, e), this
        },
...
function setFilter(e, t, n) {
    ...
    e[i + "filter"] = e[i + "filter"] || "", n = setUnit(n > jQuery.CSS.filters[t].max ? jQuery.CSS.filters[t].max : n, jQuery.CSS.filters[t].unit), e[i + "filter"] += r + "(" + n + ") ", delete e[t]
        ...
        getProp: function (e) {
            var t, n = [];
            for (t in e) 0 > n.indexOf(t) && n.push(uncamel(t));
            return n.join(",")
        },
        animate: function (e, t, n, r, i) {
            return this.each((function () {
                function a() {
                    s.called = !0, s.CSSAIsRunning = !1, o.off(jQuery.CSS.transitionEnd + "." + s.id), clearTimeout(s.timeout), o.css(jQuery.CSS.sfx + "transition", ""), "function" == typeof i && i.apply(s), "function" == typeof s.CSSqueue && (s.CSSqueue(), s.CSSqueue = null)
                }
                var s = this,
                    o = jQuery(this);
                ...
                if (s.CSSAIsRunning && s.eventType == l.type && !jQuery.browser.msie && 9 >= jQuery.browser.version) s.CSSqueue = function () {
                    o.CSSAnimate(e, t, n, r, i)
                };
                else if (s.CSSqueue = null, s.eventType = l.type, 0 !== o.length && e) {
                    if (e = jQuery.normalizeCss(e), s.CSSAIsRunning = !0, "function" == typeof t && (i = t, t = jQuery.fx.speeds._default), "function" == typeof n && (r = n, n = 0), "string" == typeof n && (i = n, n = 0), "function" == typeof r && (i = r, r = "cubic-bezier(0.65,0.03,0.36,0.72)"), "string" == typeof t)
                    ...
                    if (t || (t = jQuery.fx.speeds._default), "string" == typeof i && (r = i, i = null), jQuery.support.CSStransition) {
                        ...
                        u[r] && (r = u[r]), o.off(jQuery.CSS.transitionEnd + "." + s.id), u = jQuery.CSS.getProp(e);
                        var d = {};
                        jQuery.extend(d, e), d[jQuery.CSS.sfx + "transition-property"] = u, d[jQuery.CSS.sfx + "transition-duration"] = t + "ms", d[jQuery.CSS.sfx + "transition-delay"] = n + "ms", d[jQuery.CSS.sfx + "transition-timing-function"] = r, setTimeout((function () {
                            o.one(jQuery.CSS.transitionEnd + "." + s.id, a), o.css(d)
                        }), 1), s.timeout = setTimeout((function () {
                            s.called || !i ? (s.called = !1, s.CSSAIsRunning = !1) : (o.css(jQuery.CSS.sfx + "transition", ""), i.apply(s), s.CSSAIsRunning = !1, "function" == typeof s.CSSqueue && (s.CSSqueue(), s.CSSqueue = null))
                        }), t + n + 10)
                    } else {
                        for (u in e) "transform" === u && delete e[u], "filter" === u && delete e[u], "transform-origin" === u && delete e[u], "auto" === e[u] && delete e[u], "x" === u && (l = e[u], e[c = "left"] = l, delete e[u]), "y" === u && (l = e[u], e[c = "top"] = l, delete e[u]), "-ms-transform" !== u && "-ms-filter" !== u || delete e[u];
                        o.delay(n).animate(e, t, i)
                    }
                }
            }))
        }
        ...
        e.simpleSlider = {
            ...
            init: function (t) {
                return this.each((function () {
                    ...
                    i = e("<div/>").addClass("level").addClass(i), r.prepend(i), n.level = i, r.css({
                        cursor: "default"
                    }), "auto" == n.opt.maxval && (n.opt.maxval = e(n).outerWidth()), r.updateSliderVal(), n.opt.readonly || (r.on(e.simpleSlider.events.start, (function (t) {
                        e.browser.mobile && (t = t.changedTouches[0]), n.canSlide = !0, r.updateSliderVal(t), "h" === n.opt.orientation ? r.css({
                            cursor: "col-resize"
                        }) : r.css({
                            cursor: "row-resize"
                        }), n.lastVal = n.val, e.browser.mobile || (t.preventDefault(), t.stopPropagation())
    ...
    function (e) {
        e.mbCookie = {
            set: function (e, t, n, r) {
                ...
                var i = new Date,
                    a = "";
                0 < n && (i.setTime(i.getTime() + 864e5 * n), a = "; expires=" + i.toGMTString()), document.cookie = e + "=" + t + a + "; path=/" + r
            },
            get: function (e) {
                e += "=";
...
var pJS = function (e, t) {
    ...
    t && Object.deepExtend(r, t), r.tmp.obj = {
    ...
    }, r.fn.particle = function (e, t, n) {
        if (this.radius = (r.particles.size.random ? Math.random() : 1) * r.particles.size.value, r.particles.size.anim.enable && (this.size_status = !1, this.vs = r.particles.size.anim.speed / 100, r.particles.size.anim.sync || (this.vs = this.vs * Math.random())), this.x = n ? n.x : Math.random() * r.canvas.w, this.y = n ? n.y : Math.random() * r.canvas.h, this.x > r.canvas.w - 2 * this.radius ? this.x = this.x - this.radius : this.x < 2 * this.radius && (this.x = this.x + this.radius), this.y > r.canvas.h - 2 * this.radius ? this.y = this.y - this.radius : this.y < 2 * this.radius && (this.y = this.y + this.radius), r.particles.move.bounce && r.fn.vendors.checkOverlap(this, n), this.color = {}, "object" == typeof e.value)
            if (e.value instanceof Array) {
                var i = e.value[Math.floor(Math.random() * r.particles.color.value.length)];
        ...
        switch (r.canvas.ctx.fillStyle = i, r.canvas.ctx.beginPath(), e.shape) {
            ...
            case "image":
                ...
                else a = r.tmp.img_obj;
                a && r.canvas.ctx.drawImage(a, e.x - t, e.y - t, 2 * t, 2 * t / e.img.ratio)
        }
        ...
        if (a <= r.particles.line_linked.distance) {
            var s = r.particles.line_linked.opacity - a / (1 / r.particles.line_linked.opacity) / r.particles.line_linked.distance;
            if (s > 0) {
                var o = r.particles.line_linked.color_rgb_line;
                r.canvas.ctx.strokeStyle = "rgba(" + o.r + "," + o.g + "," + o.b + "," + s + ")", r.canvas.ctx.lineWidth = r.particles.line_linked.width, r.canvas.ctx.beginPath(), r.canvas.ctx.moveTo(e.x, e.y), r.canvas.ctx.lineTo(t.x, t.y), r.canvas.ctx.stroke(), r.canvas.ctx.closePath()
            }
        }
        ...
        if (r.interactivity.events.onhover.enable && isInArray("bubble", r.interactivity.events.onhover.mode)) {
            var t = e.x - r.interactivity.mouse.pos_x,
                n = e.y - r.interactivity.mouse.pos_y,
                i = 1 - (c = Math.sqrt(t * t + n * n)) / r.interactivity.modes.bubble.distance;

            function a() {
                e.opacity_bubble = e.opacity, e.radius_bubble = e.radius
            }
            if (c <= r.interactivity.modes.bubble.distance) {
                if (i >= 0 && "mousemove" == r.interactivity.status) {
                    if (r.interactivity.modes.bubble.size != r.particles.size.value)
                        if (r.interactivity.modes.bubble.size > r.particles.size.value)(o = e.radius + r.interactivity.modes.bubble.size * i) >= 0 && (e.radius_bubble = o);
                        else {
                            var s = e.radius - r.interactivity.modes.bubble.size,
                                o = e.radius - s * i;
                            e.radius_bubble = o > 0 ? o : 0
                        } var l;
                    r.interactivity.modes.bubble.opacity != r.particles.opacity.value && (r.interactivity.modes.bubble.opacity > r.particles.opacity.value ? (l = r.interactivity.modes.bubble.opacity * i) > e.opacity && l <= r.interactivity.modes.bubble.opacity && (e.opacity_bubble = l) : (l = e.opacity - (r.particles.opacity.value - r.interactivity.modes.bubble.opacity) * i) < e.opacity && l >= r.interactivity.modes.bubble.opacity && (e.opacity_bubble = l))
                }
            } else a();
            ...
            if (r.tmp.bubble_clicking) {
                t = e.x - r.interactivity.mouse.click_pos_x, n = e.y - r.interactivity.mouse.click_pos_y;
            ...
            function d(t, n, i, a, s) {
                if (t != n)
                    if (r.tmp.bubble_duration_end) null != i && (l = t + (t - (a - u * (a - t) / r.interactivity.modes.bubble.duration)), "size" == s && (e.radius_bubble = l), "opacity" == s && (e.opacity_bubble = l));
                    else if (c <= r.interactivity.modes.bubble.distance) {
                    if (null != i) var o = i;
                    else o = a;
                    if (o != t) {
                        var l = a - u * (a - t) / r.interactivity.modes.bubble.duration;
            ...
            r.tmp.bubble_clicking && (d(r.interactivity.modes.bubble.size, r.particles.size.value, e.radius_bubble, e.radius, "size"), d(r.interactivity.modes.bubble.opacity, r.particles.opacity.value, e.opacity_bubble, e.opacity, "opacity"))
        }
        ...
        if (r.interactivity.events.onhover.enable && isInArray("repulse", r.interactivity.events.onhover.mode) && "mousemove" == r.interactivity.status) {
            var t = e.x - r.interactivity.mouse.pos_x,
                ...
                s = clamp(1 / (l = r.interactivity.modes.repulse.distance) * (-1 * Math.pow(i / l, 2) + 1) * l * 100, 0, 50),
                o = {
                    x: e.x + a.x * s,
                    y: e.y + a.y * s
                };
            "bounce" == r.particles.move.out_mode ? (o.x - e.radius > 0 && o.x + e.radius < r.canvas.w && (e.x = o.x), o.y - e.radius > 0 && o.y + e.radius < r.canvas.h && (e.y = o.y)) : (e.x = o.x, e.y = o.y)
            ...
            if (r.tmp.repulse_finish || (r.tmp.repulse_count++, r.tmp.repulse_count == r.particles.array.length && (r.tmp.repulse_finish = !0)), r.tmp.repulse_clicking) {
                var l = Math.pow(r.interactivity.modes.repulse.distance / 6, 3),
                    c = r.interactivity.mouse.click_pos_x - e.x,
                ...
                d <= l && function () {
                    ...
                    if (e.vx = p * Math.cos(t), e.vy = p * Math.sin(t), "bounce" == r.particles.move.out_mode) {
                        ...
                        (n.x + e.radius > r.canvas.w || n.x - e.radius < 0) && (e.vx = -e.vx), (n.y + e.radius > r.canvas.h || n.y - e.radius < 0) && (e.vy = -e.vy)
                    }
                }()
        ...
        if (r.interactivity.events.onhover.enable && "mousemove" == r.interactivity.status) {
            ...
            if (i <= r.interactivity.modes.grab.distance) {
                ...
                if (a > 0) {
                    ...
                    r.canvas.ctx.strokeStyle = "rgba(" + s.r + "," + s.g + "," + s.b + "," + a + ")", r.canvas.ctx.lineWidth = r.particles.line_linked.width, r.canvas.ctx.beginPath(), r.canvas.ctx.moveTo(e.x, e.y), r.canvas.ctx.lineTo(r.interactivity.mouse.pos_x, r.interactivity.mouse.pos_y), r.canvas.ctx.stroke(), r.canvas.ctx.closePath()
                }
            }
        }
        ...
        for (var n = 0; n < r.particles.array.length; n++) {
            var i = r.particles.array[n],
                a = e.x - i.x,
                s = e.y - i.y;
            Math.sqrt(a * a + s * s) <= e.radius + i.radius && (e.x = t ? t.x : Math.random() * r.canvas.w, e.y = t ? t.y : Math.random() * r.canvas.h, r.fn.vendors.checkOverlap(e))
        }
    }, r.fn.vendors.createSvgImg = function (e) {
        var t = r.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, (function (t, n, r, i) {
        ...
        s.addEventListener("load", (function () {
            e.img.obj = s, e.img.loaded = !0, i.revokeObjectURL(a), r.tmp.count_svg++
        })), s.src = a
    }, r.fn.vendors.destroypJS = function () {
        cancelAnimationFrame(r.fn.drawAnimFrame), n.remove(), pJSDom = null
    }, r.fn.vendors.drawShape = function (e, t, n, r, i, a) {
        var s = i * a,
            o = i / a,
            l = 180 * (o - 2) / o,
            c = Math.PI - Math.PI * l / 180;
        e.save(), e.beginPath(), e.translate(t, n), e.moveTo(0, 0);
        for (var u = 0; u < s; u++) e.lineTo(r, 0), e.translate(r, 0), e.rotate(c);
        e.fill(), e.restore()
...
Object.deepExtend = function (e, t) {
        ...
        a.className = r, a.style.width = "100%", a.style.height = "100%", null != document.getElementById(e).appendChild(a) && pJSDom.push(new pJS(e, t))
    ...
    function (e, t) {
        ...
        return function (e, t, n, r) {
                ...
                detectFeatures: function () {
                    ...
                    if (n.oldIE = document.all && !document.addEventListener, n.touch = "ontouchstart" in window, window.requestAnimationFrame && (n.raf = window.requestAnimationFrame, n.caf = window.cancelAnimationFrame), n.pointerEvent = !!window.PointerEvent || navigator.msPointerEnabled, !n.pointerEvent) {
                        ...
                        var s = r.match(/Android\s([0-9\.]*)/),
                            o = s ? s[1] : 0;
                        (o = parseFloat(o)) >= 1 && (o < 4.4 && (n.isOldAndroid = !0), n.androidVersion = o), n.isMobileOpera = /opera mini|opera mobi/i.test(r)
                    }
            ...
            i.detectFeatures(), i.features.oldIE && (i.bind = function (e, t, n, r) {
                t = t.split(" ");
                for (var i, a = (r ? "detach" : "attach") + "Event", s = function () {
            ...
            i.extend(s, r);
            var o, l, c, u, d, p, f, m, h, g, y, v, b, w, T, x, P, C, S, E, k, Y, _, j, M, A, $, I, D, O, Q, L, B, z, R, F, N, q, H, V, W, U, X, G, Z, K, J, ee, te, ne, re, ie, ae, se, oe, le, ce = {
                    x: 0,
                    y: 0
                },
                ue = {
                ...
                Se = function (e) {
                    ...
                    if (t) {
                        ...
                        n.shift();
                        for (var r = 0; r < t.length; r++) t[r].apply(a, n)
                    }
                },
                Ee = function () {
                    return (new Date).getTime()
                ...
                Ye = function (e, t, n, r, i) {
                    (!we || i && i !== a.currItem) && (r /= i ? i.fitRatio : a.currItem.fitRatio), e[Y] = v + t + "px, " + n + "px" + b + " scale(" + r + ")"
                },
                _e = function (e) {
                    te && (e && (g > a.currItem.fitRatio ? we || (Gt(a.currItem, !1, !0), we = !0) : we && (Gt(a.currItem), we = !1)), Ye(te, de.x, de.y, g))
                },
                je = function (e) {
                ...
                Ae = function (e, t) {
                    if (!s.loop && t) {
                        var n = u + (he.x * fe - e) / he.x,
                            r = Math.round(e - ut.x);
                        (n < 0 && r > 0 || n >= Rt() - 1 && r < 0) && (e = ut.x + r * s.mainScrollEndFriction)
                    }
                    ut.x = e, Me(e, d)
                },
                $e = function (e, t) {
                ...
                Oe = null,
                Qe = function () {
                    Oe && (i.unbind(document, "mousemove", Qe), i.addClass(e, "pswp--has_mouse"), s.mouseUsed = !0, Se("mouseUsed")), Oe = setTimeout((function () {
                        Oe = null
                    }), 100)
                },
                Le = function (e, t) {
                    var n = Vt(a.currItem, pe, e);
                    return t && (ee = n), n
                },
                Be = function (e) {
                ...
                Re = function (e, t, n, r) {
                    return r === a.currItem.initialZoomLevel ? (n[e] = a.currItem.initialPosition[e], !0) : (n[e] = $e(e, r), n[e] > t.min[e] ? (n[e] = t.min[e], !0) : n[e] < t.max[e] && (n[e] = t.max[e], !0))
                },
                Fe = function (e) {
                    var t = "";
                ...
                Ne = function (e) {
                    e && (U || W || ne || N) && (e.preventDefault(), e.stopPropagation())
                },
                qe = function () {
                ...
                Ve = 0,
                We = function (e) {
                    He[e] && (He[e].raf && A(He[e].raf), Ve--, delete He[e])
                },
                Ue = function (e) {
                    He[e] && We(e), He[e] || (Ve++, He[e] = {})
                },
                Xe = function () {
                    for (var e in He) He.hasOwnProperty(e) && We(e)
                },
                Ge = function (e, t, n, r, i, a, s) {
                    var o, l = Ee();
                    Ue(e);
                    var c = function () {
                        if (He[e]) {
                            if ((o = Ee() - l) >= r) return We(e), a(n), void(s && s());
                            a((n - t) * i(o / r) + t), He[e].raf = M(c)
                        }
                    };
                    c()
                },
                Ze = {
                    ...
                    setScrollOffset: function (e, t) {
                        me.x = e, O = me.y = t, Se("updateScrollOffset", me)
                    },
                    applyZoomPan: function (e, t, n, r) {
                        de.x = t, de.y = n, g = e, _e(r)
                    },
                    init: function () {
                        if (!o && !l) {
                            var n;
                            a.framework = i, a.template = e, a.bg = i.getChildByClass(e, "pswp__bg"), $ = e.className, o = !0, Q = i.detectFeatures(), M = Q.raf, A = Q.caf, Y = Q.transform, D = Q.oldIE, a.scrollWrap = i.getChildByClass(e, "pswp__scroll-wrap"), a.container = i.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = x = [{
                                ...
                                function () {
                                    if (Y) {
                                        var t = Q.perspective && !j;
                                        return v = "translate" + (t ? "3d(" : "("), void(b = Q.perspective ? ", 0px)" : ")")
                                    }
                                    Y = "left", i.addClass(e, "pswp--ie"), Me = function (e, t) {
                                        t.left = e + "px"
                                    }, je = function (e) {
                            ...
                            var r = Q.isOldIOSPhone || Q.isOldAndroid || Q.isMobileOpera;
                            for (Q.animationName && Q.transform && !r || (s.showAnimationDuration = s.hideAnimationDuration = 0), n = 0; n < ve.length; n++) a["init" + ve[n]]();
                            t && (a.ui = new t(a, i)).init(), Se("firstUpdate"), u = u || s.index || 0, (isNaN(u) || u < 0 || u >= Rt()) && (u = 0), a.currItem = zt(u), (Q.isOldIOSPhone || Q.isOldAndroid) && (ye = !1), e.setAttribute("aria-hidden", "false"), s.modal && (ye ? e.style.position = "fixed" : (e.style.position = "absolute", e.style.top = i.getScrollY() + "px")), void 0 === O && (Se("initialLayout"), O = I = i.getScrollY());
                            var c = "pswp--open ";
                            for (s.mainClass && (c += s.mainClass + " "), s.showHideOpacity && (c += "pswp--animate_opacity "), c += j ? "pswp--touch" : "pswp--notouch", c += Q.animationName ? " pswp--css_animation" : "", c += Q.svg ? " pswp--svg" : "", i.addClass(e, c), a.updateSize(), p = -1, ge = null, n = 0; n < 3; n++) Me((n + p) * he.x, x[n].el.style);
                            D || i.bind(a.scrollWrap, m, a), Ce("initialZoomInEnd", (function () {
                                a.setContent(x[0], u - 1), a.setContent(x[2], u + 1), x[0].el.style.display = x[2].el.style.display = "block", s.focus && e.focus(), i.bind(document, "keydown", a), Q.transform && i.bind(a.scrollWrap, "click", a), s.mouseUsed || i.bind(document, "mousemove", Qe), i.bind(window, "resize scroll orientationchange", a), Se("bindEvents")
                            })), a.setContent(x[1], u), a.updateCurrItem(), Se("afterInit"), ye || (w = setInterval((function () {
                                Ve || H || K || g !== a.currItem.initialZoomLevel || a.updateSize()
                            }), 1e3)), i.addClass(e, "pswp--visible")
                        }
                    },
                    close: function () {
                        o && (o = !1, l = !0, Se("close"), i.unbind(window, "resize scroll orientationchange", a), i.unbind(window, "scroll", h.scroll), i.unbind(document, "keydown", a), i.unbind(document, "mousemove", Qe), Q.transform && i.unbind(a.scrollWrap, "click", a), H && i.unbind(window, f, a), clearTimeout(L), Se("unbindEvents"), Ft(a.currItem, null, !0, a.destroy))
                    },
                    destroy: function () {
                        Se("destroy"), Ot && clearTimeout(Ot), e.setAttribute("aria-hidden", "true"), e.className = $, w && clearInterval(w), i.unbind(a.scrollWrap, m, a), i.unbind(window, "scroll", a), mt(), Xe(), Pe = null
                    },
                    panTo: function (e, t, n) {
                        n || (e > ee.min.x ? e = ee.min.x : e < ee.max.x && (e = ee.max.x), t > ee.min.y ? t = ee.min.y : t < ee.max.y && (t = ee.max.y)), de.x = e, de.y = t, _e()
                    },
                    ...
                    goTo: function (e) {
                        var t = (e = xe(e)) - u;
                        ge = t, u = e, a.currItem = zt(u), fe -= t, Ae(he.x * fe), Xe(), ne = !1, a.updateCurrItem()
                    },
                    next: function () {
                        a.goTo(u + 1)
                    },
                    ...
                    updateCurrZoomItem: function (e) {
                        ...
                        ee = a.currItem.bounds, y = g = a.currItem.initialZoomLevel, de.x = ee.center.x, de.y = ee.center.y, e && Se("afterChange")
                    },
                    ...
                    updateCurrItem: function (e) {
                        if (0 !== ge) {
                            var t, n = Math.abs(ge);
                            if (!(e && n < 2)) {
                                a.currItem = zt(u), we = !1, Se("beforeChange", ge), n >= 3 && (p += ge + (ge > 0 ? -3 : 3), n = 3);
                                for (var r = 0; r < n; r++) ge > 0 ? (t = x.shift(), x[2] = t, p++, Me((p + 2) * he.x, t.el.style), a.setContent(t, u - n + r + 1 + 1)) : (t = x.pop(), x.unshift(t), p--, Me(p * he.x, t.el.style), a.setContent(t, u + n - r - 1 - 1));
                                if (te && 1 === Math.abs(ge)) {
                                    var i = zt(P);
                                    i.initialZoomLevel !== g && (Vt(i, pe), Gt(i), je(i))
                                }
                                ge = 0, a.updateCurrZoomItem(), P = u, Se("afterChange")
                            }
                        }
                    },
                    updateSize: function (t) {
                        if (!ye && s.modal) {
                            var n = i.getScrollY();
                            if (O !== n && (e.style.top = n + "px", O = n), !t && be.x === window.innerWidth && be.y === window.innerHeight) return;
                            be.x = window.innerWidth, be.y = window.innerHeight, e.style.height = be.y + "px"
                        }
                        if (pe.x = a.scrollWrap.clientWidth, pe.y = a.scrollWrap.clientHeight, qe(), he.x = pe.x + Math.round(pe.x * s.spacing), he.y = pe.y, Ae(he.x * fe), Se("beforeResize"), void 0 !== p) {
                            for (var r, o, l, c = 0; c < 3; c++) r = x[c], Me((c + p) * he.x, r.el.style), l = u + c - 1, s.loop && Rt() > 2 && (l = xe(l)), (o = zt(l)) && (T || o.needsUpdate || !o.bounds) ? (a.cleanSlide(o), a.setContent(r, l), 1 === c && (a.currItem = o, a.updateCurrZoomItem(!0)), o.needsUpdate = !1) : -1 === r.index && l >= 0 && a.setContent(r, l), o && o.container && (Vt(o, pe), Gt(o), je(o));
                            T = !1
                        }
                        y = g = a.currItem.initialZoomLevel, (ee = a.currItem.bounds) && (de.x = ee.center.x, de.y = ee.center.y, _e(!0)), Se("resize")
                    },
                    zoomTo: function (e, t, n, r, a) {
                        t && (y = g, dt.x = Math.abs(t.x) - de.x, dt.y = Math.abs(t.y) - de.y, Ie(ue, de));
                        var s = Le(e, !1),
                            o = {};
                        ...
                        De(o);
                        var d = function (t) {
                            1 === t ? (g = e, de.x = o.x, de.y = o.y) : (g = (e - l) * t + l, de.x = (o.x - c) * t + c, de.y = (o.y - u) * t + u), a && a(t), _e(1 === t)
                        };
                ...
                yt = {},
                vt = function (e, t) {
                    return yt.prevent = !gt(e.target, s.isClickableElement), Se("preventDragEvent", e, t, yt), yt.prevent
                },
                bt = function (e, t) {
                ...
                St = function (e) {
                    ...
                    return _ ? (le = 0, rt.forEach((function (e) {
                        0 === le ? Ct[0] = e : 1 === le && (Ct[1] = e), le++
                    }))) : e.type.indexOf("touch") > -1 ? e.touches && e.touches.length > 0 && (Ct[0] = bt(e.touches[0], xt), e.touches.length > 1 && (Ct[1] = bt(e.touches[1], Pt))) : (xt.x = e.pageX, xt.y = e.pageY, xt.id = "", Ct[0] = xt), Ct
                },
                Et = function (e, t) {
                    var n, r, i, o, l = de[e] + t[e],
                        c = t[e] > 0,
                        u = ut.x + t.x,
                        d = ut.x - it.x;
                    if (n = l > ee.min[e] || l < ee.max[e] ? s.panEndFriction : 1, l = de[e] + t[e] * n, (s.allowPanToNext || g === a.currItem.initialZoomLevel) && (te ? "h" !== re || "x" !== e || W || (c ? (l > ee.min[e] && (n = s.panEndFriction, ee.min[e], r = ee.min[e] - ue[e]), (r <= 0 || d < 0) && Rt() > 1 ? (o = u, d < 0 && u > it.x && (o = it.x)) : ee.min.x !== ee.max.x && (i = l)) : (l < ee.max[e] && (n = s.panEndFriction, ee.max[e], r = ue[e] - ee.max[e]), (r <= 0 || d > 0) && Rt() > 1 ? (o = u, d > 0 && u < it.x && (o = it.x)) : ee.min.x !== ee.max.x && (i = l))) : o = u, "x" === e)) return void 0 !== o && (Ae(o, !0), G = o !== it.x), ee.min.x !== ee.max.x && (void 0 !== i ? de.x = i : G || (de.x += t.x * n)), void 0 !== o;
                    ne || G || g > a.currItem.fitRatio && (de[e] += t[e] * n)
                },
                kt = function (e) {
                    if (!("mousedown" === e.type && e.button > 0))
                        if (Bt) e.preventDefault();
                        else if (!q || "mousedown" !== e.type) {
                        if (vt(e, !0) && e.preventDefault(), Se("pointerDown"), _) {
                        ...
                        var n = St(e),
                            r = n.length;
                        Z = null, Xe(), H && 1 !== r || (H = ie = !0, i.bind(window, f, a), F = oe = ae = N = G = U = V = W = !1, re = null, Se("firstTouchStart", n), Ie(ue, de), ce.x = ce.y = 0, Ie(tt, n[0]), Ie(nt, tt), it.x = he.x * fe, at = [{
                            x: tt.x,
                            y: tt.y
                        }], z = B = Ee(), Le(g, !0), mt(), ht()), !K && r > 1 && !ne && !G && (y = g, W = !1, K = V = !0, ce.y = ce.x = 0, Ie(ue, de), Ie(Ke, n[0]), Ie(Je, n[1]), wt(Ke, Je, pt), dt.x = Math.abs(pt.x) - de.x, dt.y = Math.abs(pt.y) - de.y, J = ft(Ke, Je))
                    }
                },
                Yt = function (e) {
                    ...
                    if (H) {
                        var r = St(e);
                        if (re || U || K) Z = r;
                        else if (ut.x !== he.x * fe) re = "h";
                        else {
                            var a = Math.abs(r[0].x - tt.x) - Math.abs(r[0].y - tt.y);
                            Math.abs(a) >= 10 && (re = a > 0 ? "h" : "v", Z = r)
                        }
                    }
                },
                _t = function () {
                    if (Z) {
                        var e = Z.length;
                        if (0 !== e)
                            if (Ie(Ke, Z[0]), et.x = Ke.x - tt.x, et.y = Ke.y - tt.y, K && e > 1) {
                                if (tt.x = Ke.x, tt.y = Ke.y, !et.x && !et.y && function (e, t) {
                                        return e.x === t.x && e.y === t.y
                                    }(Z[1], Je)) return;
                                Ie(Je, Z[1]), W || (W = !0, Se("zoomGestureStarted"));
                                var t = ft(Ke, Je),
                                    n = It(t);
                                ...
                                var r = 1,
                                    ...
                                    o = ze();
                                if (n < i)
                                    if (s.pinchToClose && !oe && y <= a.currItem.initialZoomLevel) {
                                        var l = 1 - (i - n) / (i / 1.2);
                                        ke(l), Se("onPinchClose", l), ae = !0
                                    } else(r = (i - n) / i) > 1 && (r = 1), n = i - r * (i / 3);
                                else n > o && ((r = (n - o) / (6 * i)) > 1 && (r = 1), n = o + r * i);
                                r < 0 && (r = 0), wt(Ke, Je, lt), ce.x += lt.x - pt.x, ce.y += lt.y - pt.y, Ie(pt, lt), de.x = $e("x", n), de.y = $e("y", n), F = n > g, g = n, _e()
                            } else {
                                if (!re) return;
                                if (ie && (ie = !1, Math.abs(et.x) >= 10 && (et.x -= Z[0].x - nt.x), Math.abs(et.y) >= 10 && (et.y -= Z[0].y - nt.y)), tt.x = Ke.x, tt.y = Ke.y, 0 === et.x && 0 === et.y) return;
                                if ("v" === re && s.closeOnVerticalDrag && "fit" === s.scaleMode && g === a.currItem.initialZoomLevel) {
                                    ce.y += et.y, de.y += et.y;
                                    var c = Tt();
                                    return N = !0, Se("onVerticalDrag", c), ke(c), void _e()
                                }! function (e, t, n) {
                                    if (e - z > 50) {
                                        var r = at.length > 2 ? at.shift() : {};
                                        r.x = t, r.y = n, at.push(r), z = e
                                    }
                                }(Ee(), Ke.x, Ke.y), U = !0, ee = a.currItem.bounds, Et("x", et) || (Et("y", et), De(de), _e())
                            }
                    }
                },
                jt = function (e) {
                    ...
                    var t;
                    if (Se("pointerUp"), vt(e, !1) && e.preventDefault(), _) {
                        var n = i.arraySearch(rt, e.pointerId, "id");
                        n > -1 && (t = rt.splice(n, 1)[0], navigator.msPointerEnabled ? (t.type = {
                            4: "mouse",
                            2: "touch",
                            3: "pen"
                    ...
                    1 === l && Ie(nt, o[0]), 0 !== l || re || ne || (t || ("mouseup" === e.type ? t = {
                        x: e.pageX,
                        y: e.pageY,
                        type: "mouse"
                    ...
                    var c = -1;
                    if (0 === l && (H = !1, i.unbind(window, f, a), mt(), K ? c = 0 : -1 !== ct && (c = Ee() - ct)), ct = 1 === l ? Ee() : -1, r = -1 !== c && c < 150 ? "zoom" : "swipe", K && l < 2 && (K = !1, 1 === l && (r = "zoomPointerUp"), Se("zoomGestureEnded")), Z = null, U || W || ne || N)
                        if (Xe(), R || (R = Mt()), R.calculateSwipeSpeed("x"), N)
                            if (Tt() < s.verticalDragRange) a.close();
                            else {
                                var u = de.y,
                                    d = se;
                                Ge("verticalDrag", 0, 1, 300, i.easing.cubic.out, (function (e) {
                                    de.y = (a.currItem.initialPosition.y - u) * e + u, ke((1 - d) * e + d), _e()
                                })), Se("onVerticalDrag", 1)
                            }
                    else {
                        if ((G || ne) && 0 === l) {
                        ...
                        ne || ("swipe" === r ? !G && g > a.currItem.fitRatio && At(R) : Dt())
                    }
                },
                Mt = function () {
                    var e, t, n = {
                        ...
                        calculateSwipeSpeed: function (r) {
                            at.length > 1 ? (e = Ee() - z + 50, t = at[at.length - 2][r]) : (e = Ee() - B, t = nt[r]), n.lastFlickOffset[r] = tt[r] - t, n.lastFlickDist[r] = Math.abs(n.lastFlickOffset[r]), n.lastFlickDist[r] > 20 ? n.lastFlickSpeed[r] = n.lastFlickOffset[r] / e : n.lastFlickSpeed[r] = 0, Math.abs(n.lastFlickSpeed[r]) < .1 && (n.lastFlickSpeed[r] = 0), n.slowDownRatio[r] = .95, n.slowDownRatioReverse[r] = 1 - n.slowDownRatio[r], n.speedDecelerationRatio[r] = 1
                        },
                        ...
                        panAnimLoop: function () {
                            if (He.zoomPan && (He.zoomPan.raf = M(n.panAnimLoop), n.now = Ee(), n.timeDiff = n.now - n.lastNow, n.lastNow = n.now, n.calculateAnimOffset("x"), n.calculateAnimOffset("y"), _e(), n.calculateOverBoundsAnimOffset("x"), n.calculateOverBoundsAnimOffset("y"), n.speedDecelerationRatioAbs.x < .05 && n.speedDecelerationRatioAbs.y < .05)) return de.x = Math.round(de.x), de.y = Math.round(de.y), _e(), void We("zoomPan")
                        }
                    };
                    return n
                },
                At = function (e) {
                    ...
                    Ue("zoomPan"), e.lastNow = Ee(), e.panAnimLoop()
                },
                $t = function (e, t) {
                    var n, r, o;
                    if (ne || (ot = u), "swipe" === e) {
                        ...
                        l > 30 && (c || t.lastFlickOffset.x > 20) ? r = -1 : l < -30 && (c || t.lastFlickOffset.x < -20) && (r = 1)
                    }
                    r && ((u += r) < 0 ? (u = s.loop ? Rt() - 1 : 0, o = !0) : u >= Rt() && (u = s.loop ? 0 : Rt() - 1, o = !0), o && !s.loop || (ge += r, fe -= r, n = !0));
                    var d, p = he.x * fe,
                        f = Math.abs(p - ut.x);
                    return n || p > ut.x == t.lastFlickSpeed.x > 0 ? (d = Math.abs(t.lastFlickSpeed.x) > 0 ? f / Math.abs(t.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, ot === u && (n = !1), ne = !0, Se("mainScrollAnimStart"), Ge("mainScroll", ut.x, p, d, i.easing.cubic.out, Ae, (function () {
                        Xe(), ne = !1, ot = -1, (n || ot !== u) && a.updateCurrItem(), Se("mainScrollAnimComplete")
                ...
                Dt = function () {
                    ...
                    g < t ? e = t : g > n && (e = n);
                    var r, s = se;
                    return ae && !F && !oe && g < t ? (a.close(), !0) : (ae && (r = function (e) {
                        ke((1 - s) * e + s)
                    }), a.zoomTo(e, 0, 200, i.easing.cubic.out, r), !0)
                };
            Te("Gestures", {
                publicMethods: {
                    initGestures: function () {
                        var e = function (e, t, n, r, i) {
                            C = e + t, S = e + n, E = e + r, k = i ? e + i : ""
                        };
                        (_ = Q.pointerEvent) && Q.touch && (Q.touch = !1), _ ? navigator.msPointerEnabled ? e("MSPointer", "Down", "Move", "Up", "Cancel") : e("pointer", "down", "move", "up", "cancel") : Q.touch ? (e("touch", "start", "move", "end", "cancel"), j = !0) : e("mouse", "down", "move", "up"), f = S + " " + E + " " + k, m = C, _ && !j && (j = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), a.likelyTouchDevice = j, h[C] = kt, h[S] = Yt, h[E] = jt, k && (h[k] = h[E]), Q.touch && (m += " mousedown", f += " mousemove mouseup", h.mousedown = h[C], h.mousemove = h[S], h.mouseup = h[E]), j || (s.allowPanToNext = !1)
                    }
                }
            });
            var Ot, Qt, Lt, Bt, zt, Rt, Ft = function (t, n, r, o) {
                    var l;
                    Ot && clearTimeout(Ot), Bt = !0, Lt = !0, t.initialLayout ? (l = t.initialLayout, t.initialLayout = null) : l = s.getThumbBoundsFn && s.getThumbBoundsFn(u);
                    var d, p, f = r ? s.hideAnimationDuration : s.showAnimationDuration,
                        m = function () {
                            We("initialZoom"), r ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (ke(1), n && (n.style.display = "block"), i.addClass(e, "pswp--animated-in"), Se("initialZoom" + (r ? "OutEnd" : "InEnd"))), o && o(), Bt = !1
                        };
                    if (!f || !l || void 0 === l.x) return Se("initialZoom" + (r ? "Out" : "In")), g = t.initialZoomLevel, Ie(de, t.initialPosition), _e(), e.style.opacity = r ? 0 : 1, ke(1), void(f ? setTimeout((function () {
                        m()
                    }), f) : m());
                    d = c, p = !a.currItem.src || a.currItem.loadError || s.showHideOpacity, t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), r || (g = l.w / t.w, de.x = l.x, de.y = l.y - I, a[p ? "template" : "bg"].style.opacity = .001, _e()), Ue("initialZoom"), r && !d && i.removeClass(e, "pswp--animated-in"), p && (r ? i[(d ? "remove" : "add") + "Class"](e, "pswp--animate_opacity") : setTimeout((function () {
                        ...
                        if (Se("initialZoom" + (r ? "Out" : "In")), r) {
                            var n = l.w / t.w,
                                ...
                                o = se,
                                c = function (t) {
                                    1 === t ? (g = n, de.x = l.x, de.y = l.y - O) : (g = (n - s) * t + s, de.x = (l.x - a.x) * t + a.x, de.y = (l.y - O - a.y) * t + a.y), _e(), p ? e.style.opacity = 1 - t : ke(o - t * o)
                                };
                            d ? Ge("initialZoom", 0, 1, f, i.easing.cubic.out, c, m) : (c(1), Ot = setTimeout(m, f + 20))
                        } else g = t.initialZoomLevel, Ie(de, t.initialPosition), _e(), ke(1), p ? e.style.opacity = 1 : ke(1), Ot = setTimeout(m, f + 20)
                    }), r ? 25 : 90)
                },
                Nt = {},
                qt = [],
                ...
                Vt = function (e, t, n) {
                    if (e.src && !e.loadError) {
                        ...
                        if (r && (e.vGap || (e.vGap = {
                                top: 0,
                                bottom: 0
                            }), Se("parseVerticalMargin", e)), Nt.x = t.x, Nt.y = t.y - e.vGap.top - e.vGap.bottom, r) {
                            var i = Nt.x / e.w,
                                a = Nt.y / e.h;
                            e.fitRatio = i < a ? i : a;
                            var o = s.scaleMode;
                        ...
                        return function (e, t, n) {
                            var r = e.bounds;
                            r.center.x = Math.round((Nt.x - t) / 2), r.center.y = Math.round((Nt.y - n) / 2) + e.vGap.top, r.max.x = t > Nt.x ? Math.round(Nt.x - t) : r.center.x, r.max.y = n > Nt.y ? Math.round(Nt.y - n) + e.vGap.top : r.center.y, r.min.x = t > Nt.x ? 0 : r.center.x, r.min.y = n > Nt.y ? e.vGap.top : r.center.y
                ...
                Wt = function (e, t, n, r, i, s) {
                    t.loadError || r && (t.imageAppended = !0, Gt(t, r, t === a.currItem && we), n.appendChild(r), s && setTimeout((function () {
                ...
                Zt = function () {
                    if (qt.length) {
                        for (var e, t = 0; t < qt.length; t++)(e = qt[t]).holder.index === e.index && Wt(e.index, e.item, e.baseDiv, e.img, 0, e.clearPlaceholder);
                        qt = []
                    }
                };
            Te("Controller", {
                publicMethods: {
                    lazyLoadItem: function (e) {
                        e = xe(e);
                        var t = zt(e);
                        t && (!t.loaded && !t.loading || T) && (Se("gettingData", e, t), t.src && Ut(t))
                    },
                    initController: function () {
                        i.extend(s, Ht, !0), a.items = Qt = n, zt = a.getItemAt, Rt = s.getNumItemsFn, s.loop, Rt() < 3 && (s.loop = !1), Ce("beforeChange", (function (e) {
                            var t, n = s.preload,
                                r = null === e || e >= 0,
                                i = Math.min(n[0], Rt()),
                                o = Math.min(n[1], Rt());
                            for (t = 1; t <= (r ? o : i); t++) a.lazyLoadItem(u + t);
                            for (t = 1; t <= (r ? i : o); t++) a.lazyLoadItem(u - t)
                    ...
                    allowProgressiveImg: function () {
                        return s.forceProgressiveLoading || !j || s.mouseUsed || screen.width > 1200
                    },
                    setContent: function (e, t) {
                        s.loop && (t = xe(t));
                        var n = a.getItemAt(e.index);
                        n && (n.container = null);
                        var r, l = a.getItemAt(t);
                        if (l) {
                            Se("gettingData", t, l), e.index = t, e.item = l;
                            var c = l.container = i.createEl("pswp__zoom-wrap");
                            if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Xt(l), Vt(l, pe), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((r = i.createEl("pswp__img", "img")).style.opacity = 1, r.src = l.src, Gt(l, r), Wt(0, l, c, r));
                            else {
                                if (l.loadComplete = function (n) {
                                        if (o) {
                                            if (e && e.index === t) {
                                                if (Xt(n, !0)) return n.loadComplete = n.img = null, Vt(n, pe), je(n), void(e.index === u && a.updateCurrZoomItem());
                                                n.imageAppended ? !Bt && n.placeholder && (n.placeholder.style.display = "none", n.placeholder = null) : Q.transform && (ne || Bt) ? qt.push({
                                                    item: n,
                                                    baseDiv: c,
                                                    img: n.img,
                                                    index: t,
                                ...
                                l.loading || Ut(l), a.allowProgressiveImg() && (!Lt && Q.transform ? qt.push({
                                    item: l,
                                    baseDiv: c,
                                    img: l.img,
                                    index: t,
                            ...
                            Lt || t !== u ? je(l) : (te = c.style, Ft(l, r || l.img)), e.el.innerHTML = "", e.el.appendChild(c)
                        } else e.el.innerHTML = ""
                    },
            ...
            Te("Tap", {
                publicMethods: {
                    ...
                    onTapRelease: function (e, t) {
                        ...
                        if (t && !U && !V && !Ve) {
                            var a = t;
                            if (Kt && (clearTimeout(Kt), Kt = null, n = a, r = en, Math.abs(n.x - r.x) < 25 && Math.abs(n.y - r.y) < 25)) return void Se("doubleTap", a);
                            if ("mouse" === t.type) return void tn(e, t, "mouse");
                            if ("BUTTON" === e.target.tagName.toUpperCase() || i.hasClass(e.target, "pswp__single-tap")) return void tn(e, t);
                            Ie(en, a), Kt = setTimeout((function () {
                                tn(e, t), Kt = null
                            }), 300)
                        }
                    }
                ...
                publicMethods: {
                    ...
                    setupDesktopZoom: function (t) {
                        ...
                        var r, s = function () {
                                a.mouseZoomedIn && (i.removeClass(e, "pswp--zoomed-in"), a.mouseZoomedIn = !1), g < 1 ? i.addClass(e, "pswp--zoom-allowed") : i.removeClass(e, "pswp--zoom-allowed"), o()
                            },
                            o = function () {
                                r && (i.removeClass(e, "pswp--dragging"), r = !1)
                            };
                        Ce("resize", s), Ce("afterChange", s), Ce("pointerDown", (function () {
                            a.mouseZoomedIn && (r = !0, i.addClass(e, "pswp--dragging"))
                        })), Ce("pointerUp", o), t || s()
                    },
                    handleMouseWheel: function (e) {
                        if (g <= a.currItem.fitRatio) return s.modal && (!s.closeOnScroll || Ve || H ? e.preventDefault() : Y && Math.abs(e.deltaY) > 2 && (c = !0, a.close())), !0;
                    ...
                    toggleDesktopZoom: function (t) {
                        ...
                        var n = s.getDoubleTapZoom(!0, a.currItem),
                            r = g === n;
                        a.mouseZoomedIn = !r, a.zoomTo(r ? a.currItem.initialZoomLevel : n, t, 333), i[(r ? "remove" : "add") + "Class"](e, "pswp--zoomed-in")
                    }
                }
            });
            var nn, rn, an, sn, on, ln, cn, un, dn, pn, fn, mn, hn = {
                ...
                bn = function () {
                    if (an && clearTimeout(an), Ve || H) an = setTimeout(bn, 500);
                    else {
                        ...
                        mn ? "#" + n !== window.location.hash && history[un ? "replaceState" : "pushState"]("", document.title, r) : un ? fn.replace(r) : fn.hash = n, un = !0, rn = setTimeout((function () {
                            sn = !1
                        }), 60)
                    }
                };
            Te("History", {
                publicMethods: {
                    initHistory: function () {
                        if (i.extend(s, hn, !0), s.history) {
                            fn = window.location, pn = !1, dn = !1, un = !1, cn = gn(), mn = "pushState" in history, cn.indexOf("gid=") > -1 && (cn = (cn = cn.split("&gid=")[0]).split("?gid=")[0]), Ce("afterChange", a.updateURL), Ce("unbindEvents", (function () {
                                i.unbind(window, "hashchange", a.onHashChange)
                            }));
                            var e = function () {
                                ln = !0, dn || (pn ? history.back() : cn ? fn.hash = cn : mn ? history.pushState("", document.title, fn.pathname + fn.search) : fn.hash = ""), yn()
                            };
                            Ce("unbindEvents", (function () {
                                c && e()
                            })), Ce("destroy", (function () {
                            ...
                            t > -1 && "&" === (cn = cn.substring(0, t)).slice(-1) && (cn = cn.slice(0, -1)), setTimeout((function () {
                                o && i.bind(window, "hashchange", a.onHashChange)
                            }), 40)
                        }
                    },
                    onHashChange: function () {
                        if (gn() === cn) return dn = !0, void a.close();
                        sn || (on = !0, a.goTo(vn().pid), on = !1)
                    },
                    updateURL: function () {
                        yn(), on || (un ? nn = setTimeout(bn, 800) : bn())
                    }
                }
            }), i.extend(a, Ze)
        }
    ...
    function (e, t) {
        ...
        "use strict";
        return function (e, t) {
            var n, r, i, a, s, o, l, c, u, d, p, f, m, h, g, y, v, b, w = this,
                T = !1,
                x = !0,
                P = !0,
                C = {
                ...
                S = function (e) {
                    ...
                    for (var n, r, i = (e.target || e.srcElement).getAttribute("class") || "", a = 0; a < L.length; a++)(n = L[a]).onTap && i.indexOf("pswp__" + n.name) > -1 && (n.onTap(), r = !0);
                    if (r) {
                ...
                k = function () {
                    ...
                    e !== h && (E(r, "ui--one-slide", e), h = e)
                },
                Y = function () {
                    E(l, "share-modal--hidden", P)
                },
                _ = function () {
                    return (P = !P) ? (t.removeClass(l, "pswp__share-modal--fade-in"), setTimeout((function () {
                        P && Y()
                    }), 300)) : (Y(), setTimeout((function () {
                        P || t.addClass(l, "pswp__share-modal--fade-in")
                    }), 30)), P || M(), !1
                },
                j = function (t) {
                    var n = (t = t || window.event).target || t.srcElement;
                    return e.shout("shareLinkClick", t, n), !(!n.href || !n.hasAttribute("download") && (window.open(n.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), P || _(), 1))
                },
                M = function () {
                    for (var e, t, n, r, i = "", a = 0; a < g.shareButtons.length; a++) e = g.shareButtons[a], t = g.getImageURLForShare(e), n = g.getPageURLForShare(e), r = g.getTextForShare(e), i += '<a href="' + e.url.replace("{{url}}", encodeURIComponent(n)).replace("{{image_url}}", encodeURIComponent(t)).replace("{{raw_image_url}}", t).replace("{{text}}", encodeURIComponent(r)) + '" target="_blank" class="pswp__share--' + e.id + '"' + (e.download ? "download" : "") + ">" + e.label + "</a>", g.parseShareButtonOut && (i = g.parseShareButtonOut(e, i));
                    l.children[0].innerHTML = i, l.children[0].onclick = j
                },
                A = function (e) {
                ...
                $ = 0,
                I = function () {
                    clearTimeout(b), $ = 0, u && w.setIdle(!1)
                },
                D = function (e) {
                ...
                Q = function (n) {
                    ...
                    if (!e.likelyTouchDevice || g.mouseUsed || screen.width > g.fitControlsWidth) {
                        ...
                        if (g.captionEl && "auto" === o.bottom)
                            if (a || ((a = t.createEl("pswp__caption pswp__caption--fake")).appendChild(t.createEl("pswp__caption__center")), r.insertBefore(a, i), t.addClass(r, "pswp__ui--fit")), g.addCaptionHTMLFn(n, a, !0)) {
            ...
            w.init = function () {
                var s;
                t.extend(e.options, C, !0), g = e.options, r = t.getChildByClass(e.scrollWrap, "pswp__ui"), (d = e.listen)("onVerticalDrag", (function (e) {
                        x && e < .95 ? w.hideControls() : !x && e >= .95 && w.showControls()
                    })), d("onPinchClose", (function (e) {
                        x && e < .9 ? (w.hideControls(), s = !0) : s && !x && e > .9 && w.showControls()
                    })), d("zoomGestureEnded", (function () {
                        (s = !1) && !x && w.showControls()
                        ...
                        P || _(), v && clearInterval(v), t.unbind(document, "mouseout", D), t.unbind(document, "mousemove", I), t.unbind(r, "pswpTap click", S), t.unbind(e.scrollWrap, "pswpTap", w.onGlobalTap), t.unbind(e.scrollWrap, "mouseover", w.onMouseOver), n && (t.unbind(document, n.eventK, w.updateFullscreen), n.isFullscreen() && (g.hideAnimationDuration = 0, n.exit()), n = null)
                    })), d("destroy", (function () {
                        g.captionEl && (a && r.removeChild(a), t.removeClass(i, "pswp__caption--empty")), l && (l.children[0].onclick = null), t.removeClass(r, "pswp__ui--over-close"), t.addClass(r, "pswp__ui--hidden"), w.setIdle(!1)
                    ...
                    function () {
                        var e, n, i, a = function (r) {
                            if (r)
                                for (var a = r.length, s = 0; s < a; s++) {
                                    e = r[s], n = e.className;
                                    for (var o = 0; o < L.length; o++) i = L[o], n.indexOf("pswp__" + i.name) > -1 && (g[i.option] ? (t.removeClass(e, "pswp__element--disabled"), i.onInit && i.onInit(e)) : t.addClass(e, "pswp__element--disabled"))
                                }
                        };
                        a(r.children);
                        var s = t.getChildByClass(r, "pswp__top-bar");
                        s && a(s.children)
                    }(), g.shareEl && o && l && (P = !0), k(), g.timeToIdle && d("mouseUsed", (function () {
                        t.bind(document, "mousemove", I), t.bind(document, "mouseout", D), v = setInterval((function () {
                            2 == ++$ && w.setIdle(!0)
                        }), g.timeToIdle / 2)
                    })), g.fullscreenEl && !t.features.isOldAndroid && (n || (n = w.getFullscreenAPI()), n ? (t.bind(document, n.eventK, w.updateFullscreen), w.updateFullscreen(), t.addClass(e.template, "pswp--supports-fs")) : t.removeClass(e.template, "pswp--supports-fs")), g.preloaderEl && (O(!0), d("beforeChange", (function () {
                ...
                x && e.currItem ? (w.updateIndexIndicator(), g.captionEl && (g.addCaptionHTMLFn(e.currItem, i), E(i, "caption--empty", !e.currItem.title)), T = !0) : T = !1, P || _(), k()
                ...
                if (!y)
                    ...
                    } else if (g.tapToToggleControls && (x ? w.hideControls() : w.showControls()), g.tapToClose && (t.hasClass(r, "pswp__img") || A(r))) return void e.close()
            }, w.onMouseOver = function (e) {
                var t = (e = e || window.event).target || e.srcElement;
                E(r, "ui--over-close", A(t))
            }, w.hideControls = function () {
                t.addClass(r, "pswp__ui--hidden"), x = !1
            }, w.showControls = function () {
                x = !0, T || w.update(), t.removeClass(r, "pswp__ui--hidden")
    ...
    */
        ...
        e.ajaxChimp = {
            ...
            return e(this).each((function (n, r) {
                var i = e(r),
                    ...
                    s = i.find("label[for=" + a.attr("id") + "]"),
                    o = e.extend({
                        url: i.attr("action"),
                        language: "en"
                    }, t),
                    l = o.url.replace("/post?", "/post-json?").concat("&c=?");
                i.attr("novalidate", "true"), a.attr("name", "EMAIL"), i.submit((function () {
                    var t, n = {},
                        r = i.serializeArray();
                    e.each(r, (function (e, t) {
                        ...
                        success: function (n) {
                            if ("success" === n.result) t = "We have sent you a confirmation email", s.removeClass("error").addClass("valid"), a.removeClass("error").addClass("valid");
                                ...
                                try {
                                    var r = n.msg.split(" - ", 2);
                                    void 0 === r[1] ? t = n.msg : parseInt(r[0], 10).toString() === r[0] ? (r[0], t = r[1]) : t = n.msg
                                } catch (e) {
                                    t = n.msg
                                }
                            }
    ...
    $((function () {
        ...
        var e = $("#menu-trigger"),
            ...
            c = $("#portfolio-trigger"),
            u = $("#contact-trigger"),
            d = ($("#about-close"), $("#portfolio-close"), $("#contact-close"), $(".fullscreen-bg"));
        r.on("click", (function (n) {
            n.preventDefault(), $(".active").addClass("animate-out"), e.addClass("menu-opened"), setTimeout((function () {
                t.addClass("animate-in")
            }), 600), setTimeout((function () {
                $(".active").removeClass("animate-out animate-in")
            }), 1200)
        })), e.on("click", (function (r) {
            r.preventDefault(), t.hasClass("animate-in") ? (e.removeClass("menu-opened"), t.addClass("animate-out"), setTimeout((function () {
                $(".active").addClass("animate-in"), t.removeClass("animate-in animate-out")
            }), 600)) : ($(".active").addClass("animate-out"), e.addClass("menu-opened"), setTimeout((function () {
                t.addClass("animate-in")
            }), 600), setTimeout((function () {
                $(".active").removeClass("animate-out animate-in")
            }), 1200)), $("#notify").hasClass("animate-in") && (p.addClass("animate-out"), setTimeout((function () {
                n.removeClass("notify-is-visible"), p.removeClass("animate-in animate-out"), h.removeClass("popup-opened")
            }), 600)), $("#writealine").hasClass("animate-in") && (f.addClass("animate-out"), setTimeout((function () {
                s.removeClass("popup-is-visible"), f.removeClass("animate-in animate-out"), y.removeClass("popup-opened")
            }), 600))
        })), $(".navigation__item").on("click", (function (n) {
            $(".active").removeClass("active"), $(".active-link").removeClass("active-link"), t.addClass("animate-out"), e.removeClass("menu-opened")
        })), o.on("click", (function (e) {
            e.preventDefault(), setTimeout((function () {
                d.length && $(".gradient-layer-dark").addClass("fade-dark"), n.addClass("active animate-in"), o.addClass("active-link"), t.removeClass("animate-in animate-out")
            }), 600)
        })), l.on("click", (function (e) {
            e.preventDefault(), setTimeout((function () {
                d.length && $(".gradient-layer-dark").addClass("fade-dark"), i.addClass("active animate-in"), l.addClass("active-link"), t.removeClass("animate-in animate-out")
            }), 600)
        })), c.on("click", (function (e) {
            e.preventDefault(), setTimeout((function () {
                d.length && $(".gradient-layer-dark").addClass("fade-dark"), a.addClass("active animate-in"), c.addClass("active-link"), t.removeClass("animate-in animate-out")
            }), 600)
        })), u.on("click", (function (e) {
            e.preventDefault(), setTimeout((function () {
                d.length && $(".gradient-layer-dark").addClass("fade-dark"), s.addClass("active animate-in"), u.addClass("active-link"), t.removeClass("animate-in animate-out")
            }), 600)
        }));
        var p = $("#notify"),
            f = ($("#headline"), $("#writealine")),
            m = $("#notify-trigger"),
            h = $("#notify-close"),
            g = $("#writealine-trigger"),
            y = $("#writealine-close");
        m.on("click", (function (e) {
            e.preventDefault(), n.addClass("notify-is-visible"), setTimeout((function () {
                p.addClass("animate-in")
            }), 800), setTimeout((function () {
                h.addClass("popup-opened")
            }), 2e3)
        })), h.on("click", (function (e) {
            e.preventDefault(), p.addClass("animate-out"), setTimeout((function () {
                n.removeClass("notify-is-visible"), p.removeClass("animate-in animate-out"), h.removeClass("popup-opened")
            }), 800)
        })), g.on("click", (function (e) {
            e.preventDefault(), s.addClass("popup-is-visible"), setTimeout((function () {
                f.addClass("animate-in")
            }), 800), setTimeout((function () {
                y.addClass("popup-opened")
            }), 2e3)
        })), y.on("click", (function (e) {
            e.preventDefault(), f.addClass("animate-out"), setTimeout((function () {
                s.removeClass("popup-is-visible"), f.removeClass("animate-in animate-out"), y.removeClass("popup-opened")
            }), 800)
        }))
    }));